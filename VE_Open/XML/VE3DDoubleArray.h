 ...
 *
 * -----------------------------------------------------------------
 * File:          $RCSfile: VE3DDoubleArray.h,v $
...
/*!\file VE3DDoubleArray.h
  Double Array API
  */
/*!\class VE_XML::VE3DDoubleArray
...
namespace VE_XML
{
   class VE2DDoubleArray;
}

namespace VE_XML
{
class VE_XML_EXPORTS VE3DDoubleArray : public VEXMLObject
{
public:
   ///Constructor
   ///\param rootDoc The owning DOMDocument.
   ///\param nElements The length of the float array.
   VE3DDoubleArray(DOMDocument* rootDoc,unsigned int nElements=3);
   ///Destructor
   virtual ~VE3DDoubleArray();
   ///Copy Constructor
   VE3DDoubleArray( const VE3DDoubleArray& );
   ///equal operator
   VE3DDoubleArray& operator= ( const VE3DDoubleArray& );
...
protected:
   ...
   std::vector< VE2DDoubleArray* > ve2DDoubleArray;///<Raw data.
