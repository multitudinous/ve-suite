...
#ifndef VE_USER_WEAK_PTR_H
#define VE_USER_WEAK_PTR_H
 ...
 * VE_XML::UserWeakPtr.  To get the full 
 * declaration of VE_XML::UserWeakPtr
...
namespace VE_XML
{
    ...
    typedef Loki::StrongPtr< User, false, Loki::LockableTwoRefCounts,
        Loki::DisallowConversion, Loki::AssertCheck, Loki::CantResetWithStrong,
        Loki::DeleteSingle > UserWeakPtr;
}
#endif
