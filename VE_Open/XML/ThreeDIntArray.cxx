 ...
 *
 * -----------------------------------------------------------------
 * File:          $RCSfile: ThreeDIntArray.cxx,v $
...
//Constructor                                     //
////////////////////////////////////////////////////
ThreeDIntArray::ThreeDIntArray(DOMDocument* rootDoc,unsigned int nElements)
:XMLObject(rootDoc)
{
...
{
   twoDArray.push_back( new TwoDIntArray( _rootDocument ) );
