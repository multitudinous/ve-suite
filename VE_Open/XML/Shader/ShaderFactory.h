...
#ifndef _VE_SHADER_FACTORY_H_
#define _VE_SHADER_FACTORY_H_
...
/*!\file ShaderFactory.h
  Factory class for creating GLSL Shader objects 
  */
/*!\class VE_XML::ShaderFactory
  *Factory class for creating GLSL Shader objects
 */
namespace VE_XML
{
...
namespace VE_Shader
{
class VE_SHADER_EXPORTS ShaderFactory
{
public:
   ///Base constructor
   ShaderFactory( );
   ...
   //Template function to create an CAD
   //\param objectType The unique string specifying what object to create
   //template <class T>
   //T* CreateCAD(std::string objectType);

   ///
   ///\param objectType The unique string specifying what object to create
   VE_XML::XMLObject* CreateShaderObject(std::string objectType);
