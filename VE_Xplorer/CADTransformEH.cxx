...
void CADTransformEventHandler::_operateOnNode(VE_XML::Command* command)
{
   if(_cadNode)
   {
      VE_XML::DataValuePair* instruction = command->GetDataValuePair( 0 );
      _cadNode->SetTransform(instruction->GetDataTransform());
      //do I need to change this class to also update the osg::Node?
   }
}
