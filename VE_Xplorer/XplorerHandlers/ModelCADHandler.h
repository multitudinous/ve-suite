 ...
 *
 * -----------------------------------------------------------------
 * Date modified: $Date: 2007-05-15 20:56:59 -0500 (Tue, 15 May 2007) $
 * Version:       $Rev: 7654 $
 * Author:        $Author: biv $
 * Id:            $Id: ModelCADHandlerl.h 7654 2007-05-16 01:56:59Z biv $
 * -----------------------------------------------------------------
 *
 *************** <auto-copyright.pl END do not edit this line> ***************/
#ifndef MODEL_CAD_HANDLER_H
#define MODEL_CAD_HANDLERH
...
{
    class VE_XPLORER_EXPORTS ModelCADHandler
    {
    public:
        ///Constructor
