...
IMPLEMENT_DYNAMIC_CLASS( VERecuperator, cfdVEBaseClass )

// Constructor
VERecuperator::VERecuperator( void ) : cfdVEBaseClass()
{
...
// Destructor
VERecuperator::~VERecuperator( void )
{
   if ( _param )
      delete [] _param;
}

void VERecuperator::InitializeNode( cfdDCS* veworldDCS )
{
