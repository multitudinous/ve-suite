...
#ifndef VE_BulkDesulfurizer_H
#define VE_BulkDesulfurizer_H
...
class VEBulkDesulfurizer: public cfdVEBaseClass 
{
   DECLARE_DYNAMIC_CLASS( VEBulkDesulfurizer )

   public:
      VEBulkDesulfurizer( void );
      //VEBulkDesulfurizer( cfdDCS* );
      ~VEBulkDesulfurizer( void );
