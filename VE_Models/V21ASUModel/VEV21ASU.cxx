...
IMPLEMENT_DYNAMIC_CLASS( VEV21ASU, cfdVEBaseClass )

// Constructor
VEV21ASU::VEV21ASU( void ) : cfdVEBaseClass()
{
...
// Destructor
VEV21ASU::~VEV21ASU( void )
{
   if ( _param )
      delete [] _param;
}

void VEV21ASU::InitializeNode( cfdDCS* veworldDCS )
{
   cfdVEBaseClass::InitializeNode( veworldDCS );
   this->_param = new char[100];
   strcpy( this->_param, "./Plugins/asu.param");
   //cout << _param << endl;
   CreateObjects();
}
