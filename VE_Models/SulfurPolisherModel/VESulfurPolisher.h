...
#ifndef VE_SULFURPOLISHER_H
#define VE_SULFURPOLISHER_H
...
class VESulfurPolisher: public cfdVEBaseClass 
{
   DECLARE_DYNAMIC_CLASS( VESulfurPolisher )

   public:
      VESulfurPolisher( void );
      //VESulfurPolisher( cfdDCS* );
      ~VESulfurPolisher( void );
