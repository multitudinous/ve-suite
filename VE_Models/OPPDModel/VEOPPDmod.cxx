...
void VEOPPDmod::SetTransforms( float* scale, float* rot, float* trans)
{
...
void VEOPPDmod::GetDataFromUnit( void )
{
...
void VEOPPDmod::MakeGeodeByUserRequest( int )
{
   //this->dataRepresentation->UpdatecfdGeode();
}

//This returns the name of the module
wxString VEOPPDmod::GetName( void )
{
   return this->_objectName;
}

//This returns the description of the module, This should be a short description
wxString VEOPPDmod::GetDesc( void )
{
