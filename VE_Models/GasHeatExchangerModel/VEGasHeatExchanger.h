...
#ifndef VE_GASHEATEXCHANGER_H
#define VE_GASHEATEXCHANGER_H
...
class VEGasHeatExchanger: public cfdVEBaseClass 
{
   DECLARE_DYNAMIC_CLASS( VEGasHeatExchanger )

   public:
      VEGasHeatExchanger( void );
      //VEGasHeatExchanger( cfdDCS* );
      ~VEGasHeatExchanger( void );
