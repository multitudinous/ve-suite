...
IMPLEMENT_DYNAMIC_CLASS( VECyclone, cfdVEBaseClass )

// Constructor
VECyclone::VECyclone( void ) : cfdVEBaseClass()
{
...
// Destructor
VECyclone::~VECyclone( void )
{
   if ( _param )
      delete [] _param;
}

void VECyclone::InitializeNode( cfdDCS* veworldDCS )
{
