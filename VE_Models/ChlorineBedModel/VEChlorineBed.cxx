...
IMPLEMENT_DYNAMIC_CLASS( VEChlorineBed, cfdVEBaseClass )

// Constructor
VEChlorineBed::VEChlorineBed( void ) : cfdVEBaseClass()
{
...
// Destructor
VEChlorineBed::~VEChlorineBed( void )
{
   if ( _param )
      delete [] _param;
}

void VEChlorineBed::InitializeNode( cfdDCS* veworldDCS )
{
