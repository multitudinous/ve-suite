...
#ifndef VE_EquilibriumReactor_H
#define VE_EquilibriumReactor_H
...
class VEEquilibriumReactor: public cfdVEBaseClass 
{
   DECLARE_DYNAMIC_CLASS( VEEquilibriumReactor )

   public:
      VEEquilibriumReactor( void );
      //VEEquilibriumReactor( cfdDCS* );
      ~VEEquilibriumReactor( void );
