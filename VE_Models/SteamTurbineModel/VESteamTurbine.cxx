...
IMPLEMENT_DYNAMIC_CLASS( VESteamTurbine, cfdVEBaseClass )

// Constructor
VESteamTurbine::VESteamTurbine( void ) : cfdVEBaseClass()
{
...
// Destructor
VESteamTurbine::~VESteamTurbine( void )
{
   if ( _param )
      delete [] _param;
}

void VESteamTurbine::InitializeNode( cfdDCS* veworldDCS )
{
