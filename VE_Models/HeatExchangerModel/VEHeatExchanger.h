...
#ifndef VE_HEATEXCHANGER_H
#define VE_HEATEXCHANGER_H
...
class VEHeatExchanger: public cfdVEBaseClass 
{
   DECLARE_DYNAMIC_CLASS( VEHeatExchanger )

   public:
      VEHeatExchanger( void );
      //VEHeatExchanger( cfdDCS* );
      ~VEHeatExchanger( void );
