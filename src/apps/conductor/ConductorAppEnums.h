...
enum CONDUCTOR_APP_ENUMS
{
    ...
    APPFRAME_XPLORER_CPT,
    APPFRAME_XPLORER_UNSELECT_ALL,
    ...
    //ExportMenu.h
    //
    EXPORTMENU_SCREEN_SHOT,
    EXPORTMENU_DOT_FILE,
    EXPORTMENU_MOVIE_CAPTURE,
    EXPORTMENU_MOVIE_CAPTURE_OFF,
    ...
    USERPREFENCES_VIEW_ALIGNED_NORMALS_CHKBX,
    USERPREFENCES_DRAGGER_SCALING_CHKBX,
    USERPREFENCES_DRAGGER_SCALING_VALUE,
    USERPREFENCES_CAD_SELECTION,
    USERPREFENCES_PHYSICS_DEBUGGER_CHKBX,
    ...
    APP_TOOL_BAR_MANIPULATOR_GLOBAL,
    APP_TOOL_BAR_MANIPULATOR_LOCAL,
    APP_TOOL_BAR_MANIPULATOR_VIEW,
    ...
    APP_TOOL_BAR_CHARACTER,
    APP_TOOL_BAR_CHARACTER_SELECT,
    APP_TOOL_BAR_CHARACTER_FLY,
    APP_TOOL_BAR_CHARACTER_FLY_SELECT,
    APP_TOOL_BAR_CHARACTER_FLY_DISABLED,
