...
enum
{
    ...
    //Avail_Modules.h
    //
    AVAILABLEMODULES_FILE,
    AVAILABLEMODULES_FILESELECTED,
    AVAILABLEMODULES_FOLDER,
    AVAILABLEMODULES_FOLDERSELECTED,
    AVAILABLEMODULES_FOLDEROPENED,
    ...
    MAINTOOLBAR_RESET_CENTER_POINT,
    MAINTOOLBAR_PHYSICS,
    MAINTOOLBAR_RESET,
    MAINTOOLBAR_PAUSE,
    MAINTOOLBAR_PLAY,
    MAINTOOLBAR_STEP,
    MAINTOOLBAR_SUMMIT_JOB,
