...
BEGIN_EVENT_TABLE( QueryInputsDlg, wxDialog )
    ...
    EVT_BUTTON( QUERYINPUTSDLG_BUTTON2, QueryInputsDlg::WxButton2Click )
    EVT_BUTTON( QUERYINPUTSDLG_BUTTON1, QueryInputsDlg::WxButton1Click )
    EVT_BUTTON( QUERYINPUTSDLG_BUTTON3, QueryInputsDlg::WxButton3Click )
...
void QueryInputsDlg::CreateGUIControls()
{
    ...
    WxStaticText2 = new wxStaticText( this, QUERYINPUTSDLG_STATICTEXT2, wxT( "Selected Parameters" ), wxPoint( 311, 5 ), wxDefaultSize, 0, wxT( "WxStaticText2" ) );
    WxStaticText1 = new wxStaticText( this, QUERYINPUTSDLG_STATICTEXT1, wxT( "All Parameters" ), wxPoint( 55, 6 ), wxDefaultSize, 0, wxT( "WxStaticText1" ) );
    WxButton4 = new wxButton( this, QUERYINPUTSDLG_BUTTON4, wxT( "Cancel" ), wxPoint( 187, 439 ), wxSize( 75, 25 ), 0, wxDefaultValidator, wxT( "WxButton4" ) );
    WxButton3 = new wxButton( this, QUERYINPUTSDLG_BUTTON3, wxT( "Submit" ), wxPoint( 187, 411 ), wxSize( 75, 25 ), 0, wxDefaultValidator, wxT( "WxButton3" ) );
    WxButton2 = new wxButton( this, QUERYINPUTSDLG_BUTTON2, wxT( "<<" ), wxPoint( 198, 69 ), wxSize( 50, 25 ), 0, wxDefaultValidator, wxT( "WxButton2" ) );
    WxButton1 = new wxButton( this, QUERYINPUTSDLG_BUTTON1, wxT( ">>" ), wxPoint( 198, 35 ), wxSize( 50, 25 ), 0, wxDefaultValidator, wxT( "WxButton1" ) );

    wxArrayString arrayStringFor_WxListBox2;
    WxListBox2 = new wxListBox( this, QUERYINPUTSDLG_LISTBOX2, wxPoint( 264, 24 ), wxSize( 178, 450 ), arrayStringFor_WxListBox2, wxLB_SINGLE );

    wxArrayString arrayStringFor_WxListBox1;
    WxListBox1 = new wxListBox( this, QUERYINPUTSDLG_LISTBOX1, wxPoint( 8, 23 ), wxSize( 178, 450 ), arrayStringFor_WxListBox1, wxLB_SINGLE );
}
