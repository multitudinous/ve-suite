...
enum CONDUCTOR_LIB_ENUMS
{
    ...
    CONTOURS_SURF_TOOLS_CHK,
    VECTOR_SCALAR_CONTROL_BUTTON,
    ...
    POLYDATA_GPU_TOOLS_CHK,
    POLYDATA_PARTICLES_CHK,
    ...
    STREAMLINES_SURFACE_STREAMLINE_BUTTON,
    STREAMLINES_SET_SEED_POINTS_BUTTON,
    STREAMLINES_GPU_TOOLS_CHK,
    STREAMLINES_SURF_TOOLS_CHK,
    ...
    NAVIGATIONPANE_Z_EQUALS_ZERO_CHK,
    ...
    //DualSlider.h
    //
    DUAL_SLIDER_MAX_SPINNER,
    DUAL_SLIDER_MIN_SPINNER,

    //
    //CameraPlacementToolUIDialog.h
    //
    ...
    //OPC Var Dialog
    //
    OPC_VAR_ID_MONITORBUTTON,
    OPC_VAR_ID_CANCELBUTTON,
    OPC_VAR_ID_SETBUTTON,
    OPC_VAR_ID_WXGRID
};
