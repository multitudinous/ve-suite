...
protected:
    ...
    virtual void OnMinTextInput( wxCommandEvent& event )
    {
        event.Skip();
    }
    virtual void OnMinSlider( wxScrollEvent& event )
    {
        event.Skip();
    }
    virtual void OnMaxTextInput( wxCommandEvent& event )
    {
        event.Skip();
    }
    virtual void OnMaxSlider( wxScrollEvent& event )
    {
        event.Skip();
    }
