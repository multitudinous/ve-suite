...
#include <ves/conductor/qt/ui_Constraints.h>
...
{
////////////////////////////////////////////////////////////////////////////////
Constraints::Constraints( QWidget* parent )
    :
    QDialog( parent ),
...
////////////////////////////////////////////////////////////////////////////////
void Constraints::changeEvent( QEvent* e )
{
...
////////////////////////////////////////////////////////////////////////////////
void Constraints::on_WritePropertiesButton_clicked()
{
    if( mTempSet )
    {
...
////////////////////////////////////////////////////////////////////////////////
void Constraints::on_RefreshPropertiesButton_clicked()
{
    if( mTempSet )
    {
...
////////////////////////////////////////////////////////////////////////////////
void Constraints::on_NewFeatureButton_clicked()
{
...
////////////////////////////////////////////////////////////////////////////////
void Constraints::on_DeleteFeatureButton_clicked()
{
    if( mTempSet )
    {
...
////////////////////////////////////////////////////////////////////////////////
void Constraints::on_FeaturesList_currentTextChanged( const QString& currentText )
{
...
////////////////////////////////////////////////////////////////////////////////
void Constraints::UpdateFeatureIDSelectorChoices()
{
...
////////////////////////////////////////////////////////////////////////////////
void Constraints::on_FeatureIDSelector_currentIndexChanged( int index )
{
...
////////////////////////////////////////////////////////////////////////////////
void Constraints::ResyncFromDatabaseSlot()
{
    mTempSet = ves::xplorer::data::PropertySetPtr();
    UpdateFeatureIDSelectorChoices();
}
