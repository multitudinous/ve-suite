    ...
    case DLL_PROCESS_ATTACH:
    {
        ...
        try
        {
            ...
            if( NULL == env_dir )
            {
                ...
                fs::path plugin_dir( lib_base_dir / "conductor" / "plugins" );
#if (BOOST_VERSION >= 104600) && (BOOST_FILESYSTEM_VERSION == 3)
...
extern "C" void __attribute__(( constructor )) vrkitLibraryInit_conductor()
{
    fs::path base_dir;
    ...
    if( NULL == env_dir )
    {
        ...
        const int result =
            ...
            dladdr( ( void* ) &vrkitLibraryInit_conductor, &info );
#else
            dladdr( reinterpret_cast<void*>( &vrkitLibraryInit_conductor ), &info );
#endif
