...
//#include <ves/conductor/qt/DefaultPlugin/DefaultPlugin.h>
//#include <ves/conductor/qt/DefaultPlugin/DefaultPlugin_UIDialog.h>
...
void DefaultPlugin::SetName( const std::string& pluginName )
{
    m_name = pluginName;
}
...
QWidget* DefaultPlugin::GetFinancialDataWidget()
{
