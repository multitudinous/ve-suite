...
public:
     ...
     **/
    ves::xplorer::data::PropertySetPtr CreateNewConstraint( const std::string& contraintType );
...
private:
    ...
    std::map< std::string, ves::xplorer::data::PropertySetPtr > m_constraintTypeToSetPtrMap;
