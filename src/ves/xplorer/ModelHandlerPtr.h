...
#ifndef VE_XPLORER_MODEL_HANDLER_PTR_H
#define VE_XPLORER_MODEL_HANDLER_PTR_H
 ...
 * ves::xplorer:ModelHandler and its pointer types.
 * For the full declaration of ves::xplorer::ModelHandler
 * ves/xplorer/ModelHandler.h must be included, too.
 */
