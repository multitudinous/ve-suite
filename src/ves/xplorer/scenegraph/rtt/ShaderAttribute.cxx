...
bool ShaderAttribute::set( unsigned int index, const std::string& name, bool b0, bool b1, bool b2, bool b3 )
{
    ...
    u->setElement( index, b0, b1, b2, b3 );
    return true;
}
////////////////////////////////////////////////////////////////////////////////
...
bool ShaderAttribute::set( unsigned int index, const std::string& name, int i0, int i1, int i2, int i3 )
{
    ...
    u->setElement( index, i0, i1, i2, i3 );
    return true;
}
////////////////////////////////////////////////////////////////////////////////
    ...
    for( unsigned int i = 0; i < units.size(); i++ )
    {
        if( units[i] != NULL )
        {
            ...
            if( units[i]->t.valid() )
            {
                ...
                if( get( "g_TextureWidth" ) )
                {
                    set( i, "g_TextureWidth", units[i]->t->getTextureWidth() );
                }
                if( get( "g_TextureHeight" ) )
                {
                    set( i, "g_TextureHeight", units[i]->t->getTextureHeight() );
                }
                if( get( "g_TextureDepth" ) )
                {
                    set( i, "g_TextureDepth", units[i]->t->getTextureDepth() );
                }
            }
