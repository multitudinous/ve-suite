...
const std::string EventMapper::getKeyName( const gadget::Keys keyId ) const
{
    ...
    case KEY_UP:
        return std::string( "KEY_UP" );
    case KEY_DOWN:
        return std::string( "KEY_DOWN" );
    case KEY_LEFT:
        return std::string( "KEY_LEFT" );
    case KEY_RIGHT:
        return std::string( "KEY_RIGHT" );
    case KEY_SHIFT:
    ...
    case KEY_COMMAND:
        return std::string( "KEY_COMMAND" );
    case KEY_1:
        return std::string( "KEY_1" );
    case KEY_2:
        return std::string( "KEY_2" );
    case KEY_3:
        return std::string( "KEY_3" );
    case KEY_4:
        return std::string( "KEY_4" );
    case KEY_5:
        return std::string( "KEY_5" );
    case KEY_6:
        return std::string( "KEY_6" );
    case KEY_7:
        return std::string( "KEY_7" );
    case KEY_8:
        return std::string( "KEY_8" );
    case KEY_9:
        return std::string( "KEY_9" );
    case KEY_0:
        return std::string( "KEY_0" );
    case KEY_A:
    ...
    case KEY_ESC:
        return std::string( "KEY_ESC" );

    case MOUSE_POSX:
        return std::string( "MOUSE_POSX" );
    case MOUSE_NEGX:
        return std::string( "MOUSE_NEGX" );
    case MOUSE_POSY:
        return std::string( "MOUSE_POSY" );
    case MOUSE_NEGY:
        return std::string( "MOUSE_NEGY" );
    case MBUTTON1:
        return std::string( "MBUTTON1" );
    case MBUTTON2:
        return std::string( "MBUTTON2" );
    case MBUTTON3:
        return std::string( "MBUTTON3" );
    case MBUTTON4:
        return std::string( "MBUTTON4" );
    case MBUTTON5:
        return std::string( "MBUTTON5" );
    case MBUTTON6:
        return std::string( "MBUTTON5" );
    case MBUTTON7:
        return std::string( "MBUTTON7" );
    case MBUTTON8:
        return std::string( "MBUTTON8" );
    case MBUTTON9:
        return std::string( "MBUTTON9" );
    case NO_MBUTTON:
        return std::string( "NO_MBUTTON" );

    case MOUSE_SCROLL_UP:
        return std::string( "MOUSE_SCROLL_UP" );
    case MOUSE_SCROLL_DOWN:
        return std::string( "MOUSE_SCROLL_DOWN" );
    case MOUSE_SCROLL_LEFT:
        return std::string( "MOUSE_SCROLL_LEFT" );
    case MOUSE_SCROLL_RIGHT:
        return std::string( "MOUSE_SCROLL_RIGHT" );

    case KEY_TAB          :
        return std::string( "KEY_TAB" );
    case KEY_BACKTAB      :
        return std::string( "KEY_BACKTAB" );
    case KEY_BACKSPACE    :
        return std::string( "KEY_BACKSPACE" );
    case KEY_RETURN       :
        return std::string( "KEY_RETURN" );
    case KEY_ENTER        :
        return std::string( "KEY_ENTER" );
    case KEY_INSERT       :
    ...
    case KEY_PRIOR        :
        return std::string( "KEY_PRIOR" );
    case KEY_NEXT         :
        return std::string( "KEY_NEXT" );
    case KEY_CAPS_LOCK    :
    ...
    case KEY_F13          :
        return std::string( "KEY_F13" );
    case KEY_F14          :
        return std::string( "KEY_F14" );
    case KEY_F15          :
        return std::string( "KEY_F15" );
    case KEY_F16          :
        return std::string( "KEY_F16" );
    case KEY_F17          :
        return std::string( "KEY_F17" );
    case KEY_F18          :
        return std::string( "KEY_F18" );
    case KEY_F19          :
        return std::string( "KEY_F19" );
    case KEY_F20          :
        return std::string( "KEY_F20" );
    case KEY_F21          :
        return std::string( "KEY_F21" );
    case KEY_F22          :
        return std::string( "KEY_F22" );
    case KEY_F23          :
        return std::string( "KEY_F23" );
    case KEY_F24          :
        return std::string( "KEY_F24" );
    case KEY_F25          :
        return std::string( "KEY_F25" );
    case KEY_F26          :
        return std::string( "KEY_F26" );
    case KEY_F27          :
        return std::string( "KEY_F27" );
    case KEY_F28          :
        return std::string( "KEY_F28" );
    case KEY_F29          :
        return std::string( "KEY_F29" );
    case KEY_F30          :
        return std::string( "KEY_F30" );
    case KEY_F31          :
        return std::string( "KEY_F31" );
    case KEY_F32          :
        return std::string( "KEY_F32" );
    case KEY_F33          :
        return std::string( "KEY_F33" );
    case KEY_F34          :
        return std::string( "KEY_F34" );
    case KEY_F35          :
        return std::string( "KEY_F35" );

    case KEY_SUPER_L :
        return std::string( "KEY_SUPER_L" );
    case KEY_SUPER_R :
        return std::string( "KEY_SUPER_R" );
    case KEY_MENU    :
        return std::string( "KEY_MENU" );
    case KEY_HYPER_L :
        return std::string( "KEY_HYPER_L" );
    case KEY_HYPER_R :
        return std::string( "KEY_HYPER_R" );
    case KEY_HELP    :
        return std::string( "KEY_HELP" );
    case KEY_SPACE   :
        return std::string( "KEY_SPACE" );
    case KEY_ANY     :
        return std::string( "KEY_ANY" );

    case KEY_EXCLAM        :
        return std::string( "KEY_EXCLAM" );
    case KEY_QUOTE_DBL     :
        return std::string( "KEY_QUOTE_DBL" );
    case KEY_NUMBER_SIGN   :
        return std::string( "KEY_NUMBER_SIGN" );
    case KEY_DOLLAR        :
    ...
    case KEY_PAREN_LEFT    :
        return std::string( "KEY_PAREN_LEFT" );
    case KEY_PAREN_RIGHT   :
        return std::string( "KEY_PAREN_RIGHT" );
    case KEY_ASTERISK      :
    ...
    case KEY_LESS          :
        return std::string( "KEY_LESS" );
    case KEY_EQUAL         :
        return std::string( "KEY_EQUAL" );
    case KEY_GREATER       :
        return std::string( "KEY_GREATER" );
    case KEY_QUESTION      :
        return std::string( "KEY_QUESTION" );
    case KEY_AT            :
        return std::string( "KEY_AT" );
    case KEY_BRACKET_LEFT  :
        return std::string( "KEY_BRACKET_LEFT" );
    case KEY_BACKSLASH     :
        return std::string( "KEY_BACKSLASH" );
    case KEY_BRACKET_RIGHT :
        return std::string( "KEY_BRACKET_RIGHT" );
    case KEY_ASCII_CIRCUM  :
        return std::string( "KEY_ASCII_CIRCUM" );
    case KEY_UNDERSCORE    :
        return std::string( "KEY_UNDERSCORE" );
    case KEY_QUOTE_LEFT    :
        return std::string( "KEY_QUOTE_LEFT" );
    case KEY_BRACE_LEFT    :
        return std::string( "KEY_BRACE_LEFT" );
    case KEY_BAR           :
        return std::string( "KEY_BAR" );
    case KEY_BRACE_RIGHT   :
        return std::string( "KEY_BRACE_RIGHT" );
    case KEY_ASCII_TILDE   :
        return std::string( "KEY_ASCII_TILDE" );

    case KEY_UNKNOWN :
        return std::string( "KEY_UNKNOWN" );
    case LAST_KEY    :
