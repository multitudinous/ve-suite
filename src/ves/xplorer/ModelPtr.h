...
#ifndef VE_XPLORER_MODEL_PTR_H
#define VE_XPLORER_MODEL_PTR_H
 ...
 * ves::xplorer:Model and its pointer types.
 * For the full declaration of ves::xplorer::Model
 * ves/xplorer/Model.h must be included, too.
 */
