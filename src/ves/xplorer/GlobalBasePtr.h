...
#ifndef VE_XPLORER_GLOBAL_BASE_PTR_H
#define VE_XPLORER_GLOBAL_BASE_PTR_H
 ...
 * ves::xplorer:GlobalBase and its pointer types.
 * For the full declaration of ves::xplorer::GlobalBase
 * ves/xplorer/GlobalBase.h must be included, too.
 */
