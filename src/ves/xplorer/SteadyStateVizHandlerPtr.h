...
#ifndef VE_XPLORER_STEADY_STATE_VIZ_HANDLER_PTR_H
#define VE_XPLORER_STEADY_STATE_VIZ_HANDLER_PTR_H
 ...
 * ves::xplorer:SteadyStateVizHandler and its pointer types.
 * For the full declaration of ves::xplorer::SteadyStateVizHandler
 * ves/xplorer/SteadyStateVizHandler.h must be included, too.
 */
