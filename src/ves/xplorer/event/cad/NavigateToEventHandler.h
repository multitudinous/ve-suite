...
#ifndef VES_XPLORER_NAVIGATE_TO_EVENT_HANDLER_H
#define VES_XPLORER_NAVIGATE_TO_EVENT_HANDLER_H

/*!\file NavigateToEventHandler.h
 */

/*!\class NavigateToEventHandler
...
public:
    ...
    ///Copy Constructor
    NavigateToEventHandler( const NavigateToEventHandler& rhs );

    ///Destructor
    virtual ~NavigateToEventHandler();

    ///Equal operator
    NavigateToEventHandler& operator=( const NavigateToEventHandler& rhs );
...
#endif// VES_XPLORER_NAVIGATE_TO_EVENT_HANDLER_H
