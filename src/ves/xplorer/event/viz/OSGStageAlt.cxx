...
void OSGStageAlt::createArrow( osg::Geometry& geom, int nInstances )
{
...
float* OSGStageAlt::createPositionArray( int m, int n , vtkPoints* points)
{
...
float* OSGStageAlt::createAttitudeArray( int m, int n, vtkDataArray* dataArray)
{
...
float* OSGStageAlt::createScalarArray( int m, int n, vtkDataArray* dataArray)
{
...
int OSGStageAlt::mylog2(unsigned x)
{
...
int OSGStageAlt::mypow2(unsigned x)
{
...
osg::Geode* OSGStageAlt::createInstanced(vtkPolyData* notglyph, string vectorName, string scalarName, osg::Geode* geode)
{
