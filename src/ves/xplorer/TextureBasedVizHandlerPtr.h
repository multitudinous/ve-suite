...
#ifndef VE_XPLORER_TEXTURE_BASED_VIZ_HANDLER_PTR_H
#define VE_XPLORER_TEXTURE_BASED_VIZ_HANDLER_PTR_H
 ...
 * ves::xplorer:TextureBasedVizHandler and its pointer types.
 * For the full declaration of ves::xplorer::TextureBasedVizHandler
 * ves/xplorer/TextureBasedVizHandler.h must be included, too.
 */
