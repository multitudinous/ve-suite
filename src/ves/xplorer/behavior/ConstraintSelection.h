...
/*!\file ConstraintSelection.h
 *
 */
/*!\class ves::xplorer::behavior::ConstraintSelection
 *
 */
/*!\namespace ves::xplorer::behavior
 *
 */
class VE_XPLORER_EXPORTS ConstraintSelection
{
public:
    ///Constructor
    ConstraintSelection();
...
private:
    ...
    ///Update the location of the point constraint
