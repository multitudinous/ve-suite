...
#ifndef _VES_XPLORER_DEVICE_POINTER_H
#define _VES_XPLORER_DEVICE_POINTER_H
...
/*!\class ves::xplorer::device::Pointer
 *
 */
 ...
 *
 */
class VE_XPLORER_EXPORTS Pointer : public Device
{
public:
    ///Constructor
    Pointer();
...
private:
    ...
    gadget::PositionInterface m_pointerPosition;
    ...
    bool mDebugInfo;
    ///
    osg::ref_ptr< osg::Node > m_pointer;
    ///
    osg::ref_ptr< ves::xplorer::scenegraph::DCS > m_pointerDCS;
