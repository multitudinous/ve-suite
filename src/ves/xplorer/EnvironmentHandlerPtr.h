...
#ifndef VE_XPLORER_ENVIRONMENT_HANDLER_PTR_H
#define VE_XPLORER_ENVIRONMENT_HANDLER_PTR_H
 ...
 * ves::xplorer:EnvironmentHandler and its pointer types.
 * For the full declaration of ves::xplorer::EnvironmentHandler
 * ves/xplorer/EnvironmentHandler.h must be included, too.
 */
