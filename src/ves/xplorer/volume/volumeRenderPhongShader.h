...
static const char* vrPhongFragSource =
    {
        ...
        "gl_FragData[ 0 ] = (fastUpdate==true)?texture2D(transferFunction,vec2(frontScalar)):texture2D(transferFunction,vec2(frontScalar,backScalar));\n"
        ...
        "gl_FragData[ 0 ].rgb+= phongShading(surfaceNormal,viewVector,lightVector,gl_FragData[ 0 ].rgb);\n"
        "}\n"
        "//To handle the glow\n"
