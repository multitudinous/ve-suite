...
#ifndef _VES_OPEN_XML_SHADER_SHADER_PTR_H_
#define _VES_OPEN_XML_SHADER_SHADER_PTR_H_
 ...
 * ves::open::xml::shader::ShaderPtr.  To get the full
 * declaration of ves::open::xml::shader::Shader
