...
#ifndef VE_NETWORK_WEAK_PTR_H
#define VE_NETWORK_WEAK_PTR_H
 ...
 * VE_XML::NetworkWeakPtr.  To get the full 
 * declaration of VE_XML::NetworkWeakPtr
...
namespace VE_Model
{
    ...
    typedef Loki::StrongPtr< Network, false, Loki::LockableTwoRefCounts,
        Loki::DisallowConversion, Loki::AssertCheck, Loki::CantResetWithStrong,
        Loki::DeleteSingle > NetworkWeakPtr;
}
}
#endif
