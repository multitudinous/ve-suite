...
{
public:
    APUOVarDialog( wxWindow *parent, wxWindowID id = 1, const wxString &title = wxT( "APUOVarDialog" ), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = APUOVarDialog_STYLE );
