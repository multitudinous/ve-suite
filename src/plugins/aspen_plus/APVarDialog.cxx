...
BEGIN_EVENT_TABLE( APVarDialog, wxDialog )
    //EVT_CLOSE( APVarDialog::OnClose )
    EVT_BUTTON( ID_SETBUTTON, APVarDialog::SetButtonClick )
    EVT_TREE_SEL_CHANGED( ID_PARAMCHOICE, APVarDialog::ParamChoiceSelected )
END_EVENT_TABLE()

APVarDialog::APVarDialog(
...
void APVarDialog::CreateGUIControls()
{
    SetTitle( wxT( "APVarDialog" ) );
    SetIcon( wxNullIcon );
    SetSize( 8, 8, 775, 400 );
    Center();
...
/*void APVarDialog::OnClose( wxCloseEvent& event )
{
    Destroy();
}*/

//ParamChoiceSelected
void APVarDialog::ParamChoiceSelected( wxTreeEvent& event )
{
    //get selection
...
//SetButtonClick
void APVarDialog::SetButtonClick( wxCommandEvent& event )
{
    std::string compName = ConvertUnicode( CompName.c_str() );
...
void APVarDialog::AppendList( const char * input )
{
...
void APVarDialog::SetCompName( const char * name )
{
    this->CompName = wxString( name, wxConvUTF8 );
}

void APVarDialog::SetServiceList(
    ves::conductor::util::CORBAServiceList * serviceList )
{
    this->serviceList = serviceList;
}

void APVarDialog::SetDialogType( const char * type )
{
    this->DialogType = wxString( type, wxConvUTF8 );
}

void APVarDialog::SetIsBlock( bool isBlock )
{
    IsBlock = isBlock;
}
