...
#include "DWRunDialog.h"

BEGIN_EVENT_TABLE(DWRunDialog,wxDialog)
    EVT_CLOSE(DWRunDialog::OnClose)
    EVT_COMBOBOX(ID_MMODE,DWRunDialog::mModeSelected)
    EVT_BUTTON(ID_CANCELBUTTON,DWRunDialog::cancelButtonClick)
    EVT_BUTTON(ID_OKBUTTON,DWRunDialog::okButtonClick)
END_EVENT_TABLE()

////////////////////////////////////////////////////////////////////////////////
DWRunDialog::DWRunDialog(wxWindow *parent, wxWindowID id,
...
////////////////////////////////////////////////////////////////////////////////
DWRunDialog::~DWRunDialog()
{
} 
////////////////////////////////////////////////////////////////////////////////
void DWRunDialog::CreateGUIControls()
{
...
////////////////////////////////////////////////////////////////////////////////
void DWRunDialog::OnClose(wxCloseEvent& /*event*/)
{
    Destroy();
}
////////////////////////////////////////////////////////////////////////////////
void DWRunDialog::okButtonClick(wxCommandEvent& event)
{
}
////////////////////////////////////////////////////////////////////////////////
void DWRunDialog::cancelButtonClick(wxCommandEvent& event)
{
}
////////////////////////////////////////////////////////////////////////////////
void DWRunDialog::mPauseAfterClick(wxCommandEvent& event)
{
}
////////////////////////////////////////////////////////////////////////////////
void DWRunDialog::mModeSelected(wxCommandEvent& event )
{
    SetMode();
}
////////////////////////////////////////////////////////////////////////////////
void DWRunDialog::SetMode()
{
