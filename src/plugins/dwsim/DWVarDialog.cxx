...
BEGIN_EVENT_TABLE( DWVarDialog, wxDialog )
    EVT_CLOSE( DWVarDialog::OnClose )
    EVT_BUTTON( DW_VAR_ID_CANCELBUTTON, DWVarDialog::CancelButtonClick )
    EVT_BUTTON( DW_VAR_ID_SETBUTTON, DWVarDialog::SetButtonClick )
    EVT_BUTTON( DW_VAR_ID_MONITORBUTTON, DWVarDialog::OnMonitorVariable )
...
void DWVarDialog::CreateGUIControls()
{
    ...
    SetButton = new wxButton(this, DW_VAR_ID_SETBUTTON, wxT("Set"), wxPoint(5,5), wxSize(75,25), 0, wxDefaultValidator, wxT("SetButton"));
    SetButton->SetFont(wxFont(12, wxSWISS, wxNORMAL,wxNORMAL, false, wxT("Tahoma")));
    WxBoxSizer1->Add(SetButton,0,wxALIGN_CENTER | wxALL,5);

    CancelButton = new wxButton(this, DW_VAR_ID_CANCELBUTTON, wxT("Close"), wxPoint(90,5), wxSize(75,25), 0, wxDefaultValidator, wxT("CancelButton"));
    ...
    MonitorButton = new wxButton(this, DW_VAR_ID_MONITORBUTTON, wxT("Monitor"),
...
//for closing
void DWVarDialog::OnClose(wxCloseEvent& /*event*/)
{
    this->Destroy();
}

//CancelButtonClick
void DWVarDialog::CancelButtonClick(wxCommandEvent& event)
{
    this->Destroy();
}

// SetButtonClick
void DWVarDialog::SetButtonClick(wxCommandEvent& event)
{  
...
// SetData
void DWVarDialog::SetData( wxString name, wxString description,
...
void DWVarDialog::UpdateSizes()
{
    WxGrid->AutoSize();
    WxGrid->SetRowLabelAlignment( wxALIGN_LEFT, wxALIGN_CENTRE );
}
////////////////////////////////////////////////////////////////////////////////
void DWVarDialog::SetServiceList(
    ves::conductor::util::CORBAServiceList * serviceList )
{
    m_serviceList = serviceList;
}
////////////////////////////////////////////////////////////////////////////////
void DWVarDialog::OnMonitorVariable( wxCommandEvent& event )
{
...
///////////////////////////////////////////////////////////////////////////////
void DWVarDialog::OnCellChange(wxGridEvent& event)
{
    rowsChanged.push_back( event.GetRow() );
}
///////////////////////////////////////////////////////////////////////////////
void DWVarDialog::OnSelectCell(wxGridEvent& event)
{
    m_monitorRow =  event.GetRow();
}
///////////////////////////////////////////////////////////////////////////////
void DWVarDialog::SetComponentName( wxString name )
{
    m_compName = name;
}