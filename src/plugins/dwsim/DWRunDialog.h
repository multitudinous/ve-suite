...
#ifndef DWRUNDIALOG_H
#define DWRUNDIALOG_H
...
/*!\file DWRunDialog.h
  DWSIM Run Dialog
  */
/*!\class ves::conductor::DWRunDialog
 * This class is the dialog running DWSIM.
 */
class DWRunDialog : public wxDialog
{
public:
    ///Constructor
    DWRunDialog(wxWindow *parent, wxWindowID id = 1,
