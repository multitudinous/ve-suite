...
BEGIN_EVENT_TABLE(ADVarDialog,wxDialog)
	EVT_CLOSE(ADVarDialog::OnClose)
	EVT_BUTTON(ID_CANCELBUTTON,ADVarDialog::CancelButtonClick)
	EVT_BUTTON(ID_SETBUTTON,ADVarDialog::SetButtonClick)
    EVT_GRID_CELL_CHANGE(ADVarDialog::WxGridCellChange)
END_EVENT_TABLE()

ADVarDialog::ADVarDialog(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &position, const wxSize& size, long style)
: wxDialog(parent, id, title, position, size, style)
{
	CreateGUIControls();
}

ADVarDialog::~ADVarDialog()
{
} 

void ADVarDialog::CreateGUIControls()
{
...
//for closing
void ADVarDialog::OnClose(wxCloseEvent& /*event*/)
{
	this->Destroy();
}

//CancelButtonClick
void ADVarDialog::CancelButtonClick(wxCommandEvent& event)
{
    this->Destroy();
}

// SetButtonClick
void ADVarDialog::SetButtonClick(wxCommandEvent& event)
{  
...
// SetData
void ADVarDialog::SetData( wxString name, wxString description,
...
//WxGridCellChange
void ADVarDialog::WxGridCellChange(wxGridEvent& event)
{
	rowsChanged.push_back( event.GetRow() );
}

//WxGridCellChange
void ADVarDialog::SetComponentName( wxString name )
{
	CompName = name;
}

void ADVarDialog::SetServiceList(
