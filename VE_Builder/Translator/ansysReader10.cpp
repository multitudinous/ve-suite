 ...
 *
 * -----------------------------------------------------------------
 * File:          $RCSfile: ansysReader10.cpp,v $
 * Date modified: $Date$
 * Version:       $Rev$
 * -----------------------------------------------------------------
 *
...
ansysReader10::ansysReader10( std::string input )
{
   ansysFileName = input;
...
int64 ansysReader10::ReadIntegerAsInt64( int32 & intPosition )
{
   int64 returnValue = 0;
   if      ( !strcmp(this->ansysVersion," 8.1") )
...
int64 ansysReader10::readInt64ansys()
{
   int64 xx;
...
int32 ansysReader10::ReadNthInt32( int32 & n )
{
...
int64 ansysReader10::ReadNthInt64( int32 & n )
{
   long currentPosition = n * sizeof(int);
   fseek(this->s1,currentPosition,SEEK_SET);
...
float ansysReader10::ReadNthFloat( int32 & n )
{
   long currentPosition = n * sizeof(int);
   fseek(this->s1,currentPosition,SEEK_SET);
   float value;
...
double ansysReader10::ReadNthDouble( int32 & n )
{
   long currentPosition = n * sizeof(int);
   fseek(this->s1,currentPosition,SEEK_SET);
   double value;
...
void ansysReader10::ReadGenericBinaryHeader()
{
#ifdef PRINT_HEADERS
   ...
   std::cout<<"Item Number later:"<<itemNumber<<std::endl;
   std::cout<<"Header size :"<<headerSize<<std::endl;
   if ( ( headerSize != 100 ) )  //( headerSize != 404 ) ||
   {
#ifdef PRINT_HEADERS
      ...
      std::cout<<"Header size :"<<headerSize<<std::endl;
      if ( ( headerSize != 404 ) && ( headerSize != 100 ) )
      {
   ...
   itemNumber = 26;  //this was 27 for the previous versions...for Version 10 it is 26
   // system record size
   ...
   //std::cout<<"Integer position :"<<integerPosition<<" Num Values :"<<numValues<<std::endl;
   this->integerPosition = numValues + 3;
}


void ansysReader10::ReadRSTHeader()
{
   std::cout << "\nReading RST Header" << std::endl;

   // the number at the next integer position 131
   std::cout<<"Integer position :"<<this->integerPosition<<std::endl;
   int32 blockSize_1 = ReadNthInt32( this->integerPosition );
   if ( blockSize_1 != 40 )
   {
      std::cerr << "blockSize = " << blockSize_1 << " != 40" << std::endl;
      exit( 1 );
   }
...
void ansysReader10::ReadDOFBlock()
{
   ...
   std::cout<<"Integer position :"<<this->integerPosition<<std::endl;
   int32 blockSize_1 = ReadNthInt32( this->integerPosition );
   std::cout<<"Block size :"<<blockSize_1<<std::endl;
...
void ansysReader10::ReadNodalEquivalencyTable()
{
...
void ansysReader10::ReadElementEquivalencyTable()
{
...
void ansysReader10::ReadDataStepsIndexTable()
{
   ...
   int32 numValues = ReadNthInt32( intPosition );
   if ( blockSize_1 != 2 * this->maxNumberDataSets )
   {
...
void ansysReader10::ReadTimeTable()
{
   if ( this->ptrTIM == 0 )
      return;
...
void ansysReader10::ReadGeometryTable()
{
   if ( this->ptrGEO == 0 )
      return;
   ...
   if ( blockSize_1 != 40 )
   {
      std::cerr << "numValues = " << blockSize_1
...
void ansysReader10::ReadElementTypeIndexTable()
{
   int32 intPosition;
   if      ( !strcmp(this->ansysVersion," 8.1") )
   {
...
void ansysReader10::ReadRealConstantsIndexTable()
{
   int32 intPosition;
   if      ( !strcmp(this->ansysVersion," 8.1") )
   ...
   {
      intPosition = this->ptrRELL;
      std::cout<<"Int position :"<<intPosition<<std::endl;
   }
...
void ansysReader10::ReadCoordinateSystemsIndexTable()
{
   int32 intPosition;
   if      ( !strcmp(this->ansysVersion," 8.1") )
...
int32 * ansysReader10::ReadElementTypeDescription( int32 pointer )
{
#ifdef PRINT_HEADERS
...
double * ansysReader10::ReadElementRealConstants( int32 pointer )
{
#ifdef PRINT_HEADERS
...
double * ansysReader10::ReadCoordinateSystemDescription( int32 pointer )
{
#ifdef PRINT_HEADERS
...
void ansysReader10::ReadNodalCoordinates_8()  // this is ansys 8.1 version
{
...
void ansysReader10::ReadNodalCoordinates_9()  // this is ansys 9.0 version
{
...
void ansysReader10::CreatePointerArrayForShellNodes()
{
...
void ansysReader10::ReadElementDescriptionIndexTable()
{
   int32 intPosition;
   if      ( !strcmp(this->ansysVersion," 8.1") )
...
void ansysReader10::ReadElementDescription( int32 elemIndex, int32 pointer )
{
   if ( pointer == 0 )
      return;
...
void ansysReader10::ReadSolutionDataHeader( int32 ptrDataSetSolution )
{
...
void ansysReader10::ReadNodalSolutions( int32 ptrDataSetSolution )
{
   if ( this->ptrNSL == 0 )
      return;
...
void ansysReader10::ReadElementSolutions( int32 ptrDataSetSolution )
{
   if ( this->ptrESL == 0 )
      return;
...
void ansysReader10::AttachStressToGrid()
{
...
void ansysReader10::ReadElementIndexTable( int32 elemIndex, int32 intPosition, int64 ptrElement_i )
{
   if ( intPosition == 0 )
      return;
/*
...
void ansysReader10::StoreNodalStessesForThisElement( int32 elemIndex,
                                                   int64 ptrElement_i )
{
...
/*
void ansysReader10::ReadHeaderExtension()
{
   if ( this->ptrEXT == 0 )
      return;
...
void ansysReader10::ReadGenericBlock( int32 & intPosition )
{
...
vtkUnstructuredGrid * ansysReader10::GetUGrid()
{
   //return this->ugrid;
...
int32 ansysReader10::VerifyNumberOfValues( int32 reportedNumValues, int32 blockSize_1 )
{
...
void ansysReader10::VerifyBlock( int32 blockSize_1, int32 blockSize_2 )
{
...
double * ansysReader10::GetIntersectionPoint( double n1[ 3 ], double n2[ 3 ],
