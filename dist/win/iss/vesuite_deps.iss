...
Source: {#DEPENDSINSTALLHOME}\{#ZMQHOME}\lib\*.lib; DestDir: {app}\lib; Flags: ignoreversion; Components: depsbuildenv
Source: {#DEPENDSINSTALLHOME}\{#ZMQHOME}\lib\*.fpc; DestDir: {app}\lib; Flags: ignoreversion recursesubdirs; Components: depsbuildenv
Source: {#DEPENDSINSTALLHOME}\{#ZMQHOME}\lib\*.dll; DestDir: {app}\lib; Flags: ignoreversion; Components: zmq
