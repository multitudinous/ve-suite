...
; libs
Source: {#LIBOGGHOME}\win32\VS2008\{#DISTDIR}\Release\*.lib; DestDir: {app}\lib; Flags: ignoreversion recursesubdirs; Languages: 
Source: {#LIBVORBISHOME}\win32\VS2008\{#DISTDIR}\Release\*.lib; DestDir: {app}\lib; Flags: ignoreversion recursesubdirs
...
; dlls
Source: {#LIBOGGHOME}\win32\VS2008\{#DISTDIR}\Release\*.dll; DestDir: {app}\lib; Flags: ignoreversion recursesubdirs
Source: {#LIBVORBISHOME}\win32\VS2008\{#DISTDIR}\Release\*.dll; DestDir: {app}\lib; Flags: ignoreversion recursesubdirs
