...
#define MyAppVer "2.79"
#define MyAppName "Bullet Pre-Compile"
#define MyAppVerName "Bullet"
...
[Files]
Source: {#VESAUTODEPSDIR}\{#BULLETDIRNAME}\{#VESINSTALLDIR}\include\*; DestDir: {app}\include; Flags: ignoreversion recursesubdirs createallsubdirs
Source: {#VESAUTODEPSDIR}\{#BULLETDIRNAME}\{#VESINSTALLDIR}\lib\*.lib; DestDir: {app}\lib; Flags: ignoreversion recursesubdirs createallsubdirs
Source: {#VESAUTODEPSDIR}\{#BULLETDIRNAME}\{#VESINSTALLDIR}\lib\*.pdb; DestDir: {app}\lib; Flags: ignoreversion recursesubdirs createallsubdirs
