...
#define MyAppName "kibitz Pre-Compile"
#define MyAppVerName "kibitz"
...
Source: {#VESAUTODEPSDIR}\{#KIBITZDIRNAME}\{#VESINSTALLDIR}\bin\*; DestDir: {app}\bin; Flags: ignoreversion
Source: {#VESAUTODEPSDIR}\{#KIBITZDIRNAME}\{#VESINSTALLDIR}\lib\*; DestDir: {app}\lib; Flags: ignoreversion recursesubdirs createallsubdirs
