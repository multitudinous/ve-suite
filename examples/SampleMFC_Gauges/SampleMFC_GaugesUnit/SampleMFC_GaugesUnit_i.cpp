...
void Body_Unit_i::StartCalc (
  ...
  ))
  {
	...
	Wrapper->updateSheet(dbllist,dbl1,dbl2);
	Wrapper->getAnswers();
	double localcalc1 = Wrapper->calc1;
	double localcalc2 = Wrapper->calc2;
	double localcalc3 = Wrapper->calc3;
	...
	p.intfs[0].setString("Calculation1",to_string(localcalc1));
	p.intfs[0].setString("Calculation2",to_string(localcalc2));
	p.intfs[0].setString("Calculation3",to_string(localcalc3));
	result = p.Save(rv);
	return_state = 1;
...
void Body_Unit_i::SetParams (
  ...
  ))
  {
	...
	dbllist = p.intfs[0].getDouble1D("dbllist");
	dbl1 = p.intfs[0].getDouble("dbl1");	
	dbl2 = p.intfs[0].getDouble("dbl2");
	int1 = p.intfs[0].getInt("int1");
	int2 = p.intfs[0].getInt("int2");
  }
