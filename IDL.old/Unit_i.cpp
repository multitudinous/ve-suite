...
void Body_Unit_i::StartCalc (
  ...
  ))
  {
    ...
    std::cout<<UnitName_<<" :StartCalc called"<<std::endl;
...
void Body_Unit_i::StopCalc (
  ...
  {
    // Add your implementation here
    std::cout<<UnitName_<<" :StopCalc called"<<std::endl;
  }
...
void Body_Unit_i::PauseCalc (
  ...
  {
    // Add your implementation here
    std::cout<<UnitName_<<" :PauseCalc called"<<std::endl;
  }
...
void Body_Unit_i::Resume (
  ...
  {
    // Add your implementation here
    std::cout<<UnitName_<<" :Resume called"<<std::endl;
  }
