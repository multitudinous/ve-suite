...
IMPLEMENT_DYNAMIC_CLASS(EvaporationCooler_UI_Dialog, UIDialog);
...
(wxWindow* parent, int id,
  ...
  double* air_humidity,
  double* ambient_pres)
: UIDialog((wxWindow *) parent, id, "EvaporationCooler"),
...
bool EvaporationCooler_UI_Dialog::TransferDataFromWindow()
{
  wxString txt;
...
////////////////////////////////////////////////////
bool EvaporationCooler_UI_Dialog::TransferDataToWindow()
{
...
void EvaporationCooler_UI_Dialog::Lock(bool l)
{
}
