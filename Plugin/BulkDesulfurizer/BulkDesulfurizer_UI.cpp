...
BEGIN_EVENT_TABLE(BulkDesulfurizer_UI_Dialog, UIDialog)
  EVT_RADIOBUTTON(R_H2S_EFF, BulkDesulfurizer_UI_Dialog::OnH2SChange)
  EVT_RADIOBUTTON(R_H2S_PPM, BulkDesulfurizer_UI_Dialog::OnH2SChange)
  EVT_RADIOBUTTON(R_COS_EFF, BulkDesulfurizer_UI_Dialog::OnCOSChange)
  EVT_RADIOBUTTON(R_COS_PPM, BulkDesulfurizer_UI_Dialog::OnCOSChange)
  EVT_RADIOBUTTON(R_PRES_SPEC, BulkDesulfurizer_UI_Dialog::OnPRESChange)
  EVT_RADIOBUTTON(R_PRES_CALC, BulkDesulfurizer_UI_Dialog::OnPRESChange)
END_EVENT_TABLE()

IMPLEMENT_DYNAMIC_CLASS(BulkDesulfurizer_UI_Dialog, UIDialog);

//Here is the constructor with passed in pointers
BulkDesulfurizer_UI_Dialog
::BulkDesulfurizer_UI_Dialog
(wxWindow* parent, int id,
  ...
  double* Solid_mass_flow,
  long* rH2S_eff_ppm,
  long* rCOS_eff_ppm,
  long* rPresDrop_spec_calc)
: UIDialog((wxWindow *) parent, id, "BulkDesulfurizer"),
  ...
  p_Particle_density(Particle_density),
  p_Solid_mass_flow(Solid_mass_flow),
  ...
  p_rPresDrop_spec_calc(rPresDrop_spec_calc)
{
  ...
  wxBoxSizer* cp_sixth_row = new wxBoxSizer(wxHORIZONTAL);
  wxBoxSizer* cp_seventh_row = new wxBoxSizer(wxHORIZONTAL);
  ...
  calc_pres_row->Add(cp_sixth_row);
  calc_pres_row->Add(5, 3, 0);
  calc_pres_row->Add(cp_seventh_row);
  calc_pres_row->Add(5, 5, 0);
  ...
  wxStaticText * label6 = new wxStaticText(this, -1, " Particle density (kg/m3) ", wxDefaultPosition, wxSize(200, 17));
  t_Particle_density = new wxTextCtrl(this, -1, wxT("15.70"), wxDefaultPosition, wxSize(80, 20));
  cp_sixth_row->Add(label6);
  cp_sixth_row->Add(t_Particle_density);

  wxStaticText * label7 = new wxStaticText(this, -1, " Solids Mass Flow (kg/s) ", wxDefaultPosition, wxSize(200, 17));
  t_Solid_mass_flow = new wxTextCtrl(this, -1, wxT("15.70"), wxDefaultPosition, wxSize(80, 20));
  cp_seventh_row->Add(label7);
  cp_seventh_row->Add(t_Solid_mass_flow);
...
bool BulkDesulfurizer_UI_Dialog::TransferDataFromWindow()
{
  wxString txt;
  ...
  txt = t_Particle_density->GetValue();
  (*p_Particle_density) = atof(txt.c_str());

  txt = t_Solid_mass_flow->GetValue();
  (*p_Solid_mass_flow) = atof(txt.c_str());
...
////////////////////////////////////////////////////
bool BulkDesulfurizer_UI_Dialog::TransferDataToWindow()
{
  ...
  txt10<<(*p_COS_eff);
  t_COS_eff->SetValue(txt10);

  txt11<<(*p_COS_ppm);
  t_COS_ppm->SetValue(txt11);
  ...
  txt12<<(*p_Particle_density);
  t_Particle_density->SetValue(txt12);

  txt13<<(*p_Solid_mass_flow);
  t_Solid_mass_flow->SetValue(txt13);
...
void BulkDesulfurizer_UI_Dialog::Lock(bool l)
{
}

///////////////////////////////////////////////////
void BulkDesulfurizer_UI_Dialog::OnH2SChange(wxCommandEvent &event)
{
...
///////////////////////////////////////////////////
void BulkDesulfurizer_UI_Dialog::OnCOSChange(wxCommandEvent &event)
{
...
///////////////////////////////////////////////////
void BulkDesulfurizer_UI_Dialog::OnPRESChange(wxCommandEvent &event)
{
  if (r_PresDrop_spec->GetValue())
    {
      ...
      t_Particle_density->Enable(false);
      t_Solid_mass_flow->Enable(false);
    }
  else
    {
      ...
      t_Particle_density->Enable(true);
      t_Solid_mass_flow->Enable(true);
    }
}
