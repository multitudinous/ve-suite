...
BEGIN_EVENT_TABLE(Compressor_UI_Dialog, UIDialog)
  EVT_RADIOBUTTON(R_CASETYPE_EVA, Compressor_UI_Dialog::OnCaseTypeChange)
  EVT_RADIOBUTTON(R_CASETYPE_DES, Compressor_UI_Dialog::OnCaseTypeChange)
END_EVENT_TABLE()

IMPLEMENT_DYNAMIC_CLASS(Compressor_UI_Dialog, UIDialog);
...
(wxWindow* parent, int id,
  ...
  long* case_type)
: UIDialog((wxWindow *) parent, id, "Compressor"),
  p_eff(eff),
...
bool Compressor_UI_Dialog::TransferDataFromWindow()
{
  wxString txt;
...
////////////////////////////////////////////////////
bool Compressor_UI_Dialog::TransferDataToWindow()
{
...
void Compressor_UI_Dialog::Lock(bool l)
{
}

///////////////////////////////////////////////////
void Compressor_UI_Dialog::OnCaseTypeChange(wxCommandEvent &event)
{
