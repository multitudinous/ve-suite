...
DOCBOOK_ROOT?=	/home/users/mikelem/MyPrograms/docbook
...
# Final DSSSL documents for DocBook. Should not have to change.
##DSSSL_DIR?=	$(DOCBOOK_ROOT)/docbook-dsssl-1.76
# Current DocBook XSL documents.
...
# NOTE: prefix is the directory path you want to put them under.

# Install HTML files into prefix directory.
...
clean:
	$(RM) *.aux *.out *.tex *.log *.fo *~ images $(CLEAN_FILES)
ifneq ($(CLEAN_DIRS), )
	$(RM) -r $(CLEAN_DIRS)
endif

#NOTE: clobber erases EVERYTHING in the .xml files' corresponding
