...
////////////////////////////////////////////////////////////////////////////////
void Block::CreateBlock( float blockScale )
{
    ...
    lineVertices->push_back( osg::Vec3( -blockScale * 0.5f, blockScale * 0.5f, blockScale * 0.5f ) );
    lineVertices->push_back( osg::Vec3( -blockScale * 0.5f, -blockScale * 0.5f, blockScale * 0.5f ) );
...
{
    osg::ref_ptr< osg::Vec4Array > colorArray = static_cast< osg::Vec4Array* >( getDrawable( 0 )->asGeometry()->getColorArray() );
