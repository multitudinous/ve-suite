 ...
 * Id:            $Id: Multiscale2GraphicalPlugin.h 16404 2011-10-07 21:20:34Z tjordan $
 * -----------------------------------------------------------------
 *
...
namespace opcgp
{
class VE_USER_PLUGIN_EXPORTS Multiscale2GraphicalPlugin : public ves::xplorer::plugin::PluginBase
{
public:
    ///Constructor
    Multiscale2GraphicalPlugin();
    ///Destructor
    virtual ~Multiscale2GraphicalPlugin();
...
CREATE_VES_XPLORER_PLUGIN_ENTRY_POINT( Multiscale2GraphicalPlugin )
