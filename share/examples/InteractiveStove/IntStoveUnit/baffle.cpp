...
///////////////////////////////////////////////////////////////////////////////
void Baffle::defineVerts( int* &baff )
{ //GOOD: CHECKED May,9,2002
...
bool Baffle::intoWall() 
{
  /* Checks to see if the creature is trying to 
    ...
    switch (baff[2]) 
	{
		case 0: if ( (baff[0]+baff[3]) > (x_cell_ct) )
				{
					// Checks RHS Stove wall
					// chopVal = (baff[0]+baff[3])-x_cell_ct;
					// chopBaff(baff,chopVal);}
					return 1;
				}
				break;
		case 1: if ( (baff[1]+baff[3]) > (y_cell_ct) )
				{
					// Checks Top Stove wall 
					// chopVal = (baff[1]+baff[3])-y_cell_ct;
					// chopBaff(baff,chopVal);}
					return 1;
				}
				break;
		case 2: if ( (baff[0]-baff[3]) < 0 )
				{    
					// Checks LHS Stove wall
					// chopVal = (baff[0]+baff[3])-x_cell_ct;
					// chopBaff(baff,chopVal);}
					return 1;
				}
				break;
		case 3: if ( (baff[1]-baff[3]) < 0 )
				{      
					// Checks Bottom Stove wall 
					// chopVal = (baff[1]+baff[3])-y_cell_ct;
					// chopBaff(baff,chopVal);}
					return 1;
				}
