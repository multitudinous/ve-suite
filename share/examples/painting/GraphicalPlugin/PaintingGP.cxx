...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::InitializeNode(
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::SetCurrentCommand( ves::open::xml::CommandPtr command )
{
    std::cout << "PaintingGP::SetCurrentCommand" << std::endl << std::flush;
    if( !command )
    {
        return;
    }
    ...
    if( commandName == "WARRANTY_TOOL_PART_TOOLS" )
    {
        ...
        else if( dvpName == "WARRANTY_FILE" )
        {
            ...
            std::cout << "PaintingGP::SetCurrentCommand::WARRANTY_FILE: " <<  filename << std::endl << std::flush;
    ...
    else if( commandName == "WARRANTY_TOOL_DB_TOOLS" )
    {
        ...
        if( !m_cadRootNode )
        {
            std::cout << "PaintingGP::SetCurrentCommand::WARRANTY_TOOL_DB_TOOLS: m_cadRootNode invalid" << std::endl << std::flush;
            return;
        }
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::SetComputerInfo( std::string const& ip, std::string const& port )
{
    ...
    {
        m_sampleThread = 
            new vpr::Thread( boost::bind( &PaintingGP::SimulatorCaptureThread, this ) );
    }
}
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::StripCharacters( std::string& data, const std::string& character )
{
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::RenderTextualDisplay( bool onOff )
{
    if( onOff )
    {
        //add 3d blocks
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::CreateDB()
{
    std::cout << "PaintingGP::CreateDB" << std::endl << std::flush;
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::CreateTextTextures()
{
    m_textTrans = new ves::xplorer::scenegraph::DCS();
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::CreateDBQuery( ves::open::xml::DataValuePairPtr dvp )
{
    std::cout << "PaintingGP::CreateDBQuery" << std::endl << std::flush;
    mCommunicationHandler->SendConductorMessage( "Creating DB query..." );
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::RemoveSelfFromSG()
{
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::StripDollarCharacters( std::string& data )
{
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::ReplaceSpacesCharacters( std::string& data )
{
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::ParseDataBase( const std::string& csvFilename )
{
    // register SQLite connector
    Poco::Data::SQLite::Connector::registerConnector();
...
////////////////////////////////////////////////////////////////////////////////
bool PaintingGP::FindPartNodeAndHighlightNode()
{
    if( !m_cadRootNode )
    {
        return false;
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::GetPartNumberFromNodeName( std::string& nodeName )
{
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::PickTextTextures()
{
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::ClearDatabaseUserTables()
{
    Poco::Data::Session session("SQLite", m_dbFilename );
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::HighlightPartsInJoinedTabled( const std::string& queryString )
{
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::QueryTableAndHighlightParts( 
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::QueryInnerJoinAndHighlightParts( const std::string& queryString )
{
    //select << "SELECT Part_Number, Description, Claims FROM Parts",
    //select << "SELECT Part_Number, Description, Claims FROM Parts WHERE Claims > 10 AND Claims_Cost > 1000",
    Poco::Data::Session session("SQLite", m_dbFilename );
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::QueryUserDefinedAndHighlightParts( const std::string& queryString )
{
    std::cout << "PaintingGP::QueryUserDefinedAndHighlightParts " << queryString << std::endl << std::flush;
    //select << "SELECT Part_Number, Description, Claims FROM Parts",
    //select << "SELECT Part_Number, Description, Claims FROM Parts WHERE Claims > 10 AND Claims_Cost > 1000",
    Poco::Data::Session session("SQLite", m_dbFilename );
    Statement select( session );
    ...
    {
        std::cout << "PaintingGP::QueryUserDefinedAndHighlightParts: exception A " << std::endl << std::flush;
        std::cout << ex.displayText() << std::endl;
        return;
    }
    catch( ... )
...
//        new ves::xplorer::scenegraph::GroupedTextTextures();
    ...
    if( !queryString.compare( 0, 12, "CREATE TABLE" ) )
    {
        ...
        {
            std::cout << "PaintingGP::QueryUserDefinedAndHighlightParts: exception B " << std::endl << std::flush;
            std::cout << ex.displayText() << std::endl;
            return;
        }       
    }
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::SaveCurrentQuery( const std::string& filename )
{
    if( !m_currentStatement )
    {
        return;
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::SimulatorCaptureThread()
{
    //std::string simState;
...
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::SetPositionData( std::vector< double >& temp )
{
    vpr::Guard<vpr::Mutex> val_guard( mValueLock );
    m_positionBuffer = temp;
}
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::GetPositionData( std::vector< double >& temp )
{
    vpr::Guard<vpr::Mutex> val_guard( mValueLock );
    temp = m_positionBuffer;
}
////////////////////////////////////////////////////////////////////////////////
void PaintingGP::CreateSensorGrid()
{
