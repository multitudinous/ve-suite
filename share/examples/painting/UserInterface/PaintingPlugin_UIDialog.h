...
#ifndef PaintingPlugin_UIDialog_H
#define PaintingPlugin_UIDialog_H
...
namespace Ui {
    class PaintingPlugin_UIDialog;
}

class PaintingPlugin_UIDialog : public QWidget
{
    Q_OBJECT

public:
    explicit PaintingPlugin_UIDialog(QWidget *parent = 0);
    ~PaintingPlugin_UIDialog();
...
#endif // PaintingPlugin_UIDialog_H
