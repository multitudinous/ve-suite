...
PaintingPlugin::PaintingPlugin():
    ...
    m_name("Sensor Demo")
{
    m_UIWidget = new PaintingPlugin_UIDialog( 0 );
}

void PaintingPlugin::SetName( const std::string& pluginName )
{
    m_name = pluginName;
}


std::string PaintingPlugin::GetName()
{
    return m_name;
}
...
QWidget* PaintingPlugin::GetFinancialDataWidget()
{
...
void PaintingPlugin::DeleteWidgets()
{
    delete m_UIWidget;
