...
#ifndef HyperLabICEPlugin_UIDialog_H
#define HyperLabICEPlugin_UIDialog_H
...
namespace Ui {
    class HyperLabICEPlugin_UIDialog;
}

class HyperLabICEPlugin_UIDialog : public QWidget
{
    Q_OBJECT

public:
    explicit HyperLabICEPlugin_UIDialog(QWidget *parent = 0);
    ~HyperLabICEPlugin_UIDialog();
...
private:
    ...
    Ui::HyperLabICEPlugin_UIDialog *ui;
...
#endif // HyperLabICEPlugin_UIDialog_H
