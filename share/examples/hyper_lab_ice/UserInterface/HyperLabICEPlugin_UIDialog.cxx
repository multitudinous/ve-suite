...
#include "ui_HyperLabICEPlugin_UIDialog.h"
...
HyperLabICEPlugin_UIDialog::HyperLabICEPlugin_UIDialog(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::HyperLabICEPlugin_UIDialog),
    m_tableCounter(0)
{
    ui->setupUi(this);
    ...
    {
        std::string signalName = "HyperLabICEPlugin_UIDialog" +
...
////////////////////////////////////////////////////////////////////////////////
void HyperLabICEPlugin_UIDialog::on_m_sensorClientConnect_clicked()
{
...
////////////////////////////////////////////////////////////////////////////////
void HyperLabICEPlugin_UIDialog::on_m_heaterClientConnect_clicked()
{
    std::cout << "get ip address and send it to xplorer" << std::endl;
    std::cout << ui->m_heaterClientIP->text().toStdString() << " " 
        << ui->m_sensorClientIP->text().toStdString() << " " 
...
////////////////////////////////////////////////////////////////////////////////
void HyperLabICEPlugin_UIDialog::on_m_testTableView_clicked()
{

}
////////////////////////////////////////////////////////////////////////////////
HyperLabICEPlugin_UIDialog::~HyperLabICEPlugin_UIDialog()
{
    delete ui;
}
////////////////////////////////////////////////////////////////////////////////
void HyperLabICEPlugin_UIDialog::changeEvent(QEvent *e)
{
