...
#ifndef ImageManipulationPlugin_UIDialog_H
#define ImageManipulationPlugin_UIDialog_H
...
namespace Ui {
    class ImageManipulationPlugin_UIDialog;
}

class ImageManipulationPlugin_UIDialog : public QWidget
{
    Q_OBJECT

public:
    explicit ImageManipulationPlugin_UIDialog(QWidget *parent = 0);
    ~ImageManipulationPlugin_UIDialog();
...
private:
    ...
    Ui::ImageManipulationPlugin_UIDialog *ui;
...
#endif // ImageManipulationPlugin_UIDialog_H
