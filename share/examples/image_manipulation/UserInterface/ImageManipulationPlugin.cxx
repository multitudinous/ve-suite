...
ImageManipulationPlugin::ImageManipulationPlugin():
    m_UIWidget(0),
    m_ResultWidget(0),
    m_FinancialDataWidget(0),
    m_InputVariablesWidget(0),
    m_ResultsVariablesWidget(0),
    m_name("Image Manipulation")
{
    m_UIWidget = new ImageManipulationPlugin_UIDialog( 0 );
}

void ImageManipulationPlugin::SetName( const std::string& pluginName )
{
    m_name = pluginName;
}


std::string ImageManipulationPlugin::GetName()
{
    return m_name;
}
...
QWidget* ImageManipulationPlugin::GetFinancialDataWidget()
{
...
void ImageManipulationPlugin::DeleteWidgets()
{
    delete m_UIWidget;
