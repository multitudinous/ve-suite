...
#include "ImageManipulationPlugin_UIDialog.h"
#include "ui_ImageManipulationPlugin_UIDialog.h"
...
ImageManipulationPlugin_UIDialog::ImageManipulationPlugin_UIDialog(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::ImageManipulationPlugin_UIDialog),
    m_tableCounter(0)
{
    ui->setupUi(this);
...
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::on_m_sensorClientConnect_clicked()
{
...
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::on_m_testTableView_clicked()
{
...
////////////////////////////////////////////////////////////////////////////////
ImageManipulationPlugin_UIDialog::~ImageManipulationPlugin_UIDialog()
{
    delete ui;
}
////////////////////////////////////////////////////////////////////////////////

void ImageManipulationPlugin_UIDialog::changeEvent(QEvent *e)
{
...
/*
void ImageManipulationPlugin_UIDialog::m_logicOperatorS_currentIndexChanged ( QString const& text )
{
...
////////////////////////////////////////////////////////////////////////////////
//void ImageManipulationPlugin_UIDialog::SendCommandsToXplorer()
//{
//    ;
//}
////////////////////////////////////////////////////////////////////////////////
// Can't find any place this is called, so commenting out. -RPT
//void ImageManipulationPlugin_UIDialog::GetTextInput( wxCommandEvent& event )
//{
...
//}
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::StripCharacters( std::string& data, const std::string& character )
{
...
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::ParseDataFile( const std::string& csvFilename )
{
    /*std::string sLine;
...
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::OnDataLoad( std::string const& fileName )
{
    /*if( !fileName.empty() )
    {
...
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::InputTextChanged( const QString& text )
{
...
////////////////////////////////////////////////////////////////////////////////
/*void ImageManipulationPlugin_UIDialog::on_m_queryTextCommandCtrl_returnPressed(  )
{
...
/*
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::OnPartSelection( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::OnPartNumberEntry( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
*/
/*void ImageManipulationPlugin_UIDialog::on_m_displayTextChkList_itemClicked
...
void ImageManipulationPlugin_UIDialog::on_m_applyButton_clicked( )
{
...
/*
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::OnDialogCancel( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::OnQueryOK( wxCommandEvent& WXUNUSED( event ) )
{
...
*/
////////////////////////////////////////////////////////////////////////////////
const std::string ImageManipulationPlugin_UIDialog::GetTextFromChoice( QComboBox* variable,
...
////////////////////////////////////////////////////////////////////////////////
const std::string ImageManipulationPlugin_UIDialog::GetTextFromLogicOperator( QComboBox* logicOperator )
{
    std::string logicString = logicOperator->currentText().toStdString();
    if( logicString == "None" )
    {
...
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::SubmitQueryCommand()
{
...
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::UpdateQueryDisplay()
{
...
void ImageManipulationPlugin_UIDialog::ParseDataBase( const std::string& csvFilename )
{
...
/*
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::OnToggleUnselected( wxCommandEvent& event )
{
    ves::open::xml::DataValuePairSharedPtr cameraGeometryOnOffDVP(
                                                                  new ves::open::xml::DataValuePair() );
...
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::OnClearData( wxCommandEvent& WXUNUSED( event ) )
{
    ves::open::xml::DataValuePairSharedPtr cameraGeometryOnOffDVP(
        new ves::open::xml::DataValuePair() );
    //Clear all the glow
...
////////////////////////////////////////////////////////////////////////////////
*/
/*void ImageManipulationPlugin_UIDialog::on_m_createTableFromQuery_toggled()
{
...
////////////////////////////////////////////////////////////////////////////////
/*
void ImageManipulationPlugin_UIDialog::OnTableSelection( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::OnMouseSelection( wxCommandEvent& event )
{
...
////////////////////////////////////////////////////////////////////////////////
void ImageManipulationPlugin_UIDialog::OnSaveQuery( wxCommandEvent& event )
{
...
////////////////////////////////////////////////////////////////////////////////
*/
void ImageManipulationPlugin_UIDialog::QueryUserDefinedAndHighlightParts( const std::string& queryString )
{
    /*std::cout << "ImageManipulationPlugin_UIDialog::QueryUserDefinedAndHighlightParts " << queryString << std::endl << std::flush;
    ...
    {
        std::cout << "ImageManipulationPlugin_UIDialog::QueryUserDefinedAndHighlightParts: exception A " << std::endl << std::flush;
        std::cout << ex.displayText() << std::endl;
        return;
    }
    catch( ... )
    ...
    if( !queryString.compare( 0, 12, "CREATE TABLE" ) )
    {
        ...
        {
            std::cout << "ImageManipulationPlugin_UIDialog::QueryUserDefinedAndHighlightParts: exception B " << std::endl << std::flush;
            std::cout << ex.displayText() << std::endl;
            return;
        }
    }
