...
#ifndef IMAGE_MANIPULATION_GP_H
#define IMAGE_MANIPULATION_GP_H
...
{
class VE_USER_PLUGIN_EXPORTS ImageManipulationPluginGP :
    public ves::xplorer::plugin::PluginBase
{
public:
    ImageManipulationPluginGP();
    virtual ~ImageManipulationPluginGP();
...
CREATE_VES_XPLORER_PLUGIN_ENTRY_POINT( ImageManipulationPluginGP )
