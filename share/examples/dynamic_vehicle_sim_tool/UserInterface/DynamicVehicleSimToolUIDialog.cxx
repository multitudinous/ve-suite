...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::SendCommandsToXplorer()
{
    ;
}
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::StripCharacters( std::string& data, const std::string& character )
{
...
////////////////////////////////////////////////////////////////////////////////
/*void DynamicVehicleSimToolUIDialog::ParseDataFile( const std::string& csvFilename )
{
    std::string sLine;
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnVariableAndLogicalChoice( wxCommandEvent& event )
{
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnCreateInputText( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnTextQueryEnter( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnPartSelection( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnPartNumberEntry( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnTextChkListToggle( wxCommandEvent& WXUNUSED( event ) )
{
    UpdateQueryDisplay();    
}
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnQueryApply( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnDialogCancel( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnQueryOK( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
const std::string DynamicVehicleSimToolUIDialog::GetTextFromChoice( wxChoice* variable,
...
////////////////////////////////////////////////////////////////////////////////
const std::string DynamicVehicleSimToolUIDialog::GetTextFromLogicOperator( wxChoice* logicOperator )
{
    std::string logicString = ConvertUnicode( logicOperator->GetStringSelection().c_str() );
    if( logicString == "None" )
    {
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::SubmitQueryCommand()
{
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::UpdateQueryDisplay()
{
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::ParseDataBase( const std::string& csvFilename )
{
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnToggleUnselected( wxCommandEvent& event )
{ 
    ves::open::xml::DataValuePairSharedPtr cameraGeometryOnOffDVP(
                                                                  new ves::open::xml::DataValuePair() );
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnClearData( wxCommandEvent& WXUNUSED( event ) )
{ 
    ves::open::xml::DataValuePairSharedPtr cameraGeometryOnOffDVP(
        new ves::open::xml::DataValuePair() );
    //Clear all the glow
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnCreateTableFromQuery( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnTableSelection( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnMouseSelection( wxCommandEvent& event )
{
...
////////////////////////////////////////////////////////////////////////////////
void DynamicVehicleSimToolUIDialog::OnSaveQuery( wxCommandEvent& WXUNUSED( event ) )
{
