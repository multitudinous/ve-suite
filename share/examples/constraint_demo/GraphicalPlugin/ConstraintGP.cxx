...
void ConstraintGP::SetCurrentCommand( ves::open::xml::CommandPtr command )
{
    ...
    if( commandName == "WARRANTY_TOOL_PART_TOOLS" )
    {
        ...
        else if( dvpName == "WARRANTY_FILE" )
        {
            ...
            std::cout << "ConstraintGP::SetCurrentCommand::WARRANTY_FILE: " <<  filename << std::endl << std::flush;
    ...
    else if( commandName == "WARRANTY_TOOL_DB_TOOLS" )
    {
        ...
        if( !m_cadRootNode )
        {
            std::cout << "ConstraintGP::SetCurrentCommand::WARRANTY_TOOL_DB_TOOLS: m_cadRootNode invalid" << std::endl << std::flush;
            return;
        }
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::SetComputerInfo( std::string const& ip, std::string const& port )
{
    ...
    {
        m_sampleThread = 
            new vpr::Thread( boost::bind( &ConstraintGP::SimulatorCaptureThread, this ) );
    }
}
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::StripCharacters( std::string& data, const std::string& character )
{
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::RenderTextualDisplay( bool onOff )
{
    if( onOff )
    {
        //add 3d blocks
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::CreateDB()
{
    std::cout << "ConstraintGP::CreateDB" << std::endl << std::flush;
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::CreateTextTextures()
{
    m_textTrans = new ves::xplorer::scenegraph::DCS();
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::CreateDBQuery( ves::open::xml::DataValuePairPtr dvp )
{
    std::cout << "ConstraintGP::CreateDBQuery" << std::endl << std::flush;
    mCommunicationHandler->SendConductorMessage( "Creating DB query..." );
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::StripDollarCharacters( std::string& data )
{
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::ReplaceSpacesCharacters( std::string& data )
{
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::ParseDataBase( const std::string& csvFilename )
{
    // register SQLite connector
    Poco::Data::SQLite::Connector::registerConnector();
...
////////////////////////////////////////////////////////////////////////////////
bool ConstraintGP::FindPartNodeAndHighlightNode()
{
    if( !m_cadRootNode )
    {
        return false;
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::GetPartNumberFromNodeName( std::string& nodeName )
{
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::PickTextTextures()
{
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::ClearDatabaseUserTables()
{
    Poco::Data::Session session("SQLite", m_dbFilename );
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::HighlightPartsInJoinedTabled( const std::string& queryString )
{
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::QueryTableAndHighlightParts( 
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::QueryInnerJoinAndHighlightParts( const std::string& queryString )
{
    //select << "SELECT Part_Number, Description, Claims FROM Parts",
    //select << "SELECT Part_Number, Description, Claims FROM Parts WHERE Claims > 10 AND Claims_Cost > 1000",
    Poco::Data::Session session("SQLite", m_dbFilename );
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::QueryUserDefinedAndHighlightParts( const std::string& queryString )
{
    std::cout << "ConstraintGP::QueryUserDefinedAndHighlightParts " << queryString << std::endl << std::flush;
    //select << "SELECT Part_Number, Description, Claims FROM Parts",
    //select << "SELECT Part_Number, Description, Claims FROM Parts WHERE Claims > 10 AND Claims_Cost > 1000",
    Poco::Data::Session session("SQLite", m_dbFilename );
    Statement select( session );
    ...
    {
        std::cout << "ConstraintGP::QueryUserDefinedAndHighlightParts: exception A " << std::endl << std::flush;
        std::cout << ex.displayText() << std::endl;
        return;
    }
    catch( ... )
...
//        new ves::xplorer::scenegraph::GroupedTextTextures();
    ...
    if( !queryString.compare( 0, 12, "CREATE TABLE" ) )
    {
        ...
        {
            std::cout << "ConstraintGP::QueryUserDefinedAndHighlightParts: exception B " << std::endl << std::flush;
            std::cout << ex.displayText() << std::endl;
            return;
        }       
    }
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::SaveCurrentQuery( const std::string& filename )
{
    if( !m_currentStatement )
    {
        return;
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::SimulatorCaptureThread()
{
    //std::string simState;
...
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::SetPositionData( std::vector< double >& temp )
{
    vpr::Guard<vpr::Mutex> val_guard( mValueLock );
    m_positionBuffer = temp;
}
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::GetPositionData( std::vector< double >& temp )
{
    vpr::Guard<vpr::Mutex> val_guard( mValueLock );
    temp = m_positionBuffer;
}
////////////////////////////////////////////////////////////////////////////////
void ConstraintGP::CreateSensorGrid()
{
