...
UIPluginInterface* WarrantyToolPluginFactory::CreateInstance()
{
...
std::string WarrantyToolPluginFactory::GetDescription()
{
    return std::string( "The generic tool to display product data." );
}


std::string WarrantyToolPluginFactory::GetHelpURL()
{
    return std::string( "" );
}


QIcon WarrantyToolPluginFactory::GetIcon( )
{
    QIcon result(":/Icons/TractorIcon.png");
    return result;
}

osg::Geode* WarrantyToolPluginFactory::GetGeometry()
{
...
Q_EXPORT_PLUGIN2( WarrantyToolPluginFactory, ves::conductor::WarrantyToolPluginFactory );
