...
// use DECLARE_LOCAL_EVENT_TYPE(...) instead of DECLARE_EVENT_TYPE, the latter needs additional DLL work
BEGIN_DECLARE_EVENT_TYPES()
	DECLARE_LOCAL_EVENT_TYPE( wxEVT_COMMAND_FIXW_UPDATED, -1 );
...
// ----------------------------------------------------------------------------
//WXDLLEXPORT
class  wxFixWidthImportCtrl : public wxControl
{
