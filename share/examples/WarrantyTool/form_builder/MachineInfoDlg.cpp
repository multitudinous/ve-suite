...
MachineInfoDlg::MachineInfoDlg( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	wxString m_variableLogicOperator00Choices[] = { wxT("Less Than"), wxT("Greater Than"), wxT("Equal"), wxT("Not Equal") };
	...
	m_textInput00 = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	wxString m_variableLogicOperator01Choices[] = { wxT("Less Than"), wxT("Greater Than"), wxT("Equal"), wxT("Not Equal") };
	...
	m_textInput01 = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	wxString m_variableLogicOperator02Choices[] = { wxT("Less Than"), wxT("Greater Than"), wxT("Equal"), wxT("Not Equal") };
	...
	m_textInput02 = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	wxString m_variableLogicOperator03Choices[] = { wxT("Less Than"), wxT("Greater Than"), wxT("Equal"), wxT("Not Equal") };
	...
	m_textInput03 = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
