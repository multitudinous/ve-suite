...
#include "AverageAirTempUnit_client.h"
#include "moduleC.h"
...
BEGIN_MESSAGE_MAP(CAverageAirTempApp, CWinApp)
   ON_COMMAND(ID_HELP, CWinApp::OnHelp)
END_MESSAGE_MAP()

CAverageAirTempApp::CAverageAirTempApp()
{
}

// The one and only CAverageAirTempApp object
CAverageAirTempApp theApp;
...
// CAverageAirTempApp initialization
BOOL CAverageAirTempApp::InitInstance()
{
   ...
   std::string UNITNAME = "AverageAirTemp";
   try {
