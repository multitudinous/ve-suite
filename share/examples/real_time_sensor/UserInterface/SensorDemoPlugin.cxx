...
SensorDemoPlugin::SensorDemoPlugin():
    m_UIWidget(0),
    m_ResultWidget(0),
    ...
    m_name("Sensor Demo")
{
    m_UIWidget = new SensorDemoPlugin_UIDialog( 0 );
}

void SensorDemoPlugin::SetName( const std::string& pluginName )
{
    m_name = pluginName;
}


std::string SensorDemoPlugin::GetName()
{
    return m_name;
}
...
QWidget* SensorDemoPlugin::GetFinancialDataWidget()
{
...
void SensorDemoPlugin::DeleteWidgets()
{
    delete m_UIWidget;
