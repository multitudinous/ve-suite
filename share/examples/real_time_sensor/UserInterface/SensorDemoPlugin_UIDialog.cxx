...
//void SensorDemoPlugin_UIDialog::GetTextInput( wxCommandEvent& event )
//{
...
////////////////////////////////////////////////////////////////////////////////
void SensorDemoPlugin_UIDialog::ParseDataFile( const std::string& csvFilename )
{
    /*std::string sLine;
...
////////////////////////////////////////////////////////////////////////////////
void SensorDemoPlugin_UIDialog::OnPartNumberEntry( wxCommandEvent& WXUNUSED( event ) )
{
...
/*
////////////////////////////////////////////////////////////////////////////////
void SensorDemoPlugin_UIDialog::OnDialogCancel( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
void SensorDemoPlugin_UIDialog::OnQueryOK( wxCommandEvent& WXUNUSED( event ) )
{
...
////////////////////////////////////////////////////////////////////////////////
const std::string SensorDemoPlugin_UIDialog::GetTextFromLogicOperator( QComboBox* logicOperator )
{
    std::string logicString = logicOperator->currentText().toStdString();
    if( logicString == "None" )
    {
...
/*
////////////////////////////////////////////////////////////////////////////////
void SensorDemoPlugin_UIDialog::OnToggleUnselected( wxCommandEvent& event )
{
    ves::open::xml::DataValuePairSharedPtr cameraGeometryOnOffDVP(
                                                                  new ves::open::xml::DataValuePair() );
...
////////////////////////////////////////////////////////////////////////////////
void SensorDemoPlugin_UIDialog::OnClearData( wxCommandEvent& WXUNUSED( event ) )
{
    ves::open::xml::DataValuePairSharedPtr cameraGeometryOnOffDVP(
        new ves::open::xml::DataValuePair() );
    //Clear all the glow
...
////////////////////////////////////////////////////////////////////////////////
void SensorDemoPlugin_UIDialog::OnMouseSelection( wxCommandEvent& event )
{
...
////////////////////////////////////////////////////////////////////////////////
void SensorDemoPlugin_UIDialog::OnSaveQuery( wxCommandEvent& event )
{
...
void SensorDemoPlugin_UIDialog::QueryUserDefinedAndHighlightParts( const std::string& queryString )
{
    ...
    {
        std::cout << "SensorDemoPlugin_UIDialog::QueryUserDefinedAndHighlightParts: exception A " << std::endl << std::flush;
        std::cout << ex.displayText() << std::endl;
        return;
    }
    catch( ... )
    ...
    if( !queryString.compare( 0, 12, "CREATE TABLE" ) )
    {
        ...
        {
            std::cout << "SensorDemoPlugin_UIDialog::QueryUserDefinedAndHighlightParts: exception B " << std::endl << std::flush;
            std::cout << ex.displayText() << std::endl;
            return;
        }
    }
