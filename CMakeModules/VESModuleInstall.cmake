...
elseif(${VES_TARGET_CATEGORY} STREQUAL "Lib" OR ${VES_TARGET_CATEGORY} STREQUAL "Plugin")
    if(${VES_TARGET_CATEGORY} STREQUAL "Lib")
        ...
        #set_target_properties( ${VES_TARGET_NAME} PROPERTIES PREFIX "")
        install(TARGETS ${VES_TARGET_NAME}
            EXPORT ${VES_TARGET_EXPORT}
            RUNTIME DESTINATION ${VES_INSTALL_BINDIR}/${VES_PLUGIN_INSTALL_DIR} COMPONENT runtime
            LIBRARY DESTINATION ${VES_INSTALL_LIBDIR}/${VES_PLUGIN_INSTALL_DIR} COMPONENT runtime
            ARCHIVE DESTINATION ${VES_INSTALL_ARCHIVEDIR}/${VES_PLUGIN_INSTALL_DIR} COMPONENT development)
    endif()
