...
# ADD LINK32 xerces-c_2.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib comctl32.lib rpcrt4.lib wsock32.lib wxmsw24d.lib /nologo /dll /debug /machine:I386 /out:"../Gasifier0D.dll" /pdbtype:sept /libpath:"$(WX_ROOT)\lib" /libpath:"$(XERCESCROOT)\lib"
