...
BEGIN_EVENT_TABLE(HeatExchanger_UI_Dialog, UIDialog)
  EVT_CHECKBOX(FINS, HeatExchanger_UI_Dialog::OnFinsChange)
END_EVENT_TABLE()

IMPLEMENT_DYNAMIC_CLASS(HeatExchanger_UI_Dialog, UIDialog);
...
(wxWindow* parent, int id,
  ...
  long* num_tubeX,
  long* use_fins)
: UIDialog((wxWindow *) parent, id, "HeatExchanger"),
  p_Sl(Sl),
  p_St(St),
  p_tube_id(tube_id),
  p_tube_od(tube_od),
...
bool HeatExchanger_UI_Dialog::TransferDataFromWindow()
{
  wxString txt;
...
////////////////////////////////////////////////////
bool HeatExchanger_UI_Dialog::TransferDataToWindow()
{
...
void HeatExchanger_UI_Dialog::Lock(bool l)
{
}

///////////////////////////////////////////////////
void HeatExchanger_UI_Dialog::OnFinsChange(wxCommandEvent &event)
{
