...
BEGIN_EVENT_TABLE(CatalyticCombustor_UI_Dialog, UIDialog)
  EVT_RADIOBUTTON(R_CASETYPE_EVA, CatalyticCombustor_UI_Dialog::OnCaseTypeChange)
  EVT_RADIOBUTTON(R_CASETYPE_DES, CatalyticCombustor_UI_Dialog::OnCaseTypeChange)
END_EVENT_TABLE()

IMPLEMENT_DYNAMIC_CLASS(CatalyticCombustor_UI_Dialog, UIDialog);
...
(wxWindow* parent, int id,
  ...
  double* velocity,
  long* case_type)
: UIDialog((wxWindow *) parent, id, "CatalyticCombustor"),
  p_effect(effect),
  p_site_den(site_den),
...
bool CatalyticCombustor_UI_Dialog::TransferDataFromWindow()
{
  wxString txt;
...
////////////////////////////////////////////////////
bool CatalyticCombustor_UI_Dialog::TransferDataToWindow()
{
...
void CatalyticCombustor_UI_Dialog::Lock(bool l)
{
}

///////////////////////////////////////////////////
void CatalyticCombustor_UI_Dialog::OnCaseTypeChange(wxCommandEvent &event)
{
