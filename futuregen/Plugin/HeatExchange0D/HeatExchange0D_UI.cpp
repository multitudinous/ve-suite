...
IMPLEMENT_DYNAMIC_CLASS(HeatExchange0D_UI_Dialog, UIDialog);
...
(wxWindow* parent, int id,
  double* desired_temp)
: UIDialog((wxWindow *) parent, id, "HeatExchange0D"),
...
bool HeatExchange0D_UI_Dialog::TransferDataFromWindow()
{
  wxString txt;
...
////////////////////////////////////////////////////
bool HeatExchange0D_UI_Dialog::TransferDataToWindow()
{
  wxString txt1;
...
void HeatExchange0D_UI_Dialog::Lock(bool l)
{
}
