#ifndef BulkDesulfurizer_UI_H
#define BulkDesulfurizer_UI_H
#include "UIDialog.h"
#include <vector>
#include <string>
...
class BulkDesulfurizer_UI_Dialog : public UIDialog
{
  DECLARE_DYNAMIC_CLASS(BulkDesulfurizer_UI_Dialog);
 public:
  BulkDesulfurizer_UI_Dialog(wxWindow* parent, int id,
          double* Temp_change,
          double* H2S_eff,
          double* H2S_ppm,
          double* COS_eff,
  ...
  virtual ~BulkDesulfurizer_UI_Dialog();
 ...
 protected:
  ...
  wxTextCtrl* t_Particle_density;
  wxTextCtrl* t_Solid_mass_flow;
 ...
 public:
  ...
  double* p_Particle_density;
  double* p_Solid_mass_flow;
  long* p_rH2S_eff_ppm;
  long* p_rCOS_eff_ppm;
