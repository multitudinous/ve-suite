...
# ADD CPP /nologo /MD /W3 /Gm /GX /ZI /Od /I "$(WX_ROOT)\include" /I "$(XERCESCROOT)\include" /I "..\\" /D "_MBCS" /D "RECUPERATOR_EXPORTS" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D WINVER=0x400 /D "_MT" /D wxUSE_GUI=1 /D "__WXDEBUG__" /D WXDEBUG=1 /D "WXUSINGDLL" /D "WXMAKING_PLUGIN_DLL" /D "_USRDLL" /D "WINDLL_EXPORTS" /D "_REENTRANT" /D "_STLP_USE_OWN_NAMESPACE" /YX /FD /GZ /c
