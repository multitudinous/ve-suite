#ifndef Recuperator_UI_H
#define Recuperator_UI_H
#include "UIDialog.h"
#include <vector>
#include <string>
...
class Recuperator_UI_Dialog : public UIDialog
{
  DECLARE_DYNAMIC_CLASS(Recuperator_UI_Dialog);
 public:
  Recuperator_UI_Dialog(wxWindow* parent, int id,
          double* Sl,
          double* St,
          double* tube_id,
          double* tube_od,
