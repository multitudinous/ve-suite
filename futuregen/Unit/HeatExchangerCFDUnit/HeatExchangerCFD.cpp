...
class HeatExchangerCFD* GAS_GLACIER_PTR;
...
void HeatExchangerCFD::setCoalType (std::string coaltype)
{
...
void HeatExchangerCFD::normalizeUlt ()
{
...
void HeatExchangerCFD::calculateProx ()
{
...
bool HeatExchangerCFD::execute (Gas *ox_in, Gas *gas_out, summary_values *summaries)
{  
  _gas_out = gas_out;
