#include "V21Helper.h"
#include <ThirdParty/Components/Bulk_Desulfurizer.h>
#include "BulkDesulfurizerUnit_i.h"
...
void Body_Unit_i::StartCalc (
  ...
  ))
  {
    ...
    if (pdrop==0) {
      ...
      Bulk_Desulf.Bed_diam = bedDiameter;
      Bulk_Desulf.Bed_L   = bedDepth;
      Bulk_Desulf.void_frac =bedFrac ;
      Bulk_Desulf.sphericity = sphericity;
      Bulk_Desulf.particle_size = particleSize;
      Bulk_Desulf.particle_dens = density;
      Bulk_Desulf.solids_flow = solidFlow;
    }
    ...
    summaries.insert_summary_val("Pressure Drop UNITS:psi FORMAT:10.2f",
				 (gas_in_data->gas_composite.P -
				  gas_out_data->gas_composite.P) / 6894.757);
