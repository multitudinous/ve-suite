...
void PipeCFD::setCoalType (std::string coaltype)
{
...
bool PipeCFD::execute (Gas *ox_in, Gas *gas_out, summary_values *summaries)
{  
  _gas_out = gas_out;
