  ...
  ))
{
  ...
  prof_out.profile_vars[0] = "I_LOC";
  prof_out.profile_vars[1] = "J_LOC";
  prof_out.profile_vars[2] = "K_LOC";
  ...
  for(iter=gas_out->gas_cell.begin(), i=0; iter!=gas_out->gas_cell.end(); iter++, i++) {
    prof_out.profile_vals[0][i] = iter->icell[0];
    prof_out.profile_vals[1][i] = iter->icell[1];
    prof_out.profile_vals[2][i] = iter->icell[2];
