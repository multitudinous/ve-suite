...
makeDrawer( btDynamicsWorld* bw, InteractionManipulator* im )
{
    ...
    btRigidBody* rb = osgbBullet::loadDae( amt, np, "USMC23_4019.ASM1.dae", bw );
      ...
      char ** argv )
{
    ...
    // create slider constraint between drawer and groundplane and add it to world
    {
        ...
        btTransform btGroundFrame = osgbBullet::asBtTransform( groundFrame );
        ...
        // Drawer space
        btTransform btDrawerFrame = osgbBullet::asBtTransform( drawerFrame );
