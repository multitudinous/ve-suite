      ...
      char ** argv )
{
    ...
    osg::ref_ptr< osgBulletPlus::HandNode > hn = new osgBulletPlus::HandNode( bulletWorld, osgBulletPlus::HandNode::RIGHT, 2. );
    ...
    osgBullet::loadDae( amt, fnn._np, "offCube0.dae", bulletWorld );
#ifdef NO_PHYSICS
