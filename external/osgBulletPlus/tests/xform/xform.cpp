      ...
      char ** argv )
{
    ...
    osg::ref_ptr< osgbBulletPlus::HandNode > hn = new osgbBulletPlus::HandNode( bulletWorld, osgbBulletPlus::HandNode::RIGHT, 2. );
    ...
    osgbBullet::loadDae( amt, fnn._np, "offCube0.dae", bulletWorld );
#ifdef NO_PHYSICS
