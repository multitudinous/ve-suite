    ...
    bool handle( const osgGA::GUIEventAdapter& ea, osgGA::GUIActionAdapter& )
    {
        switch( ea.getEventType() )
        {
            case osgGA::GUIEventAdapter::KEYDOWN:
            {
                ...
                {
                    // Save physics state.
                    osgDB::writeObjectFile( ps, "physics_state.sgb" );
                    return( true );
                }
                else if( ea.getKey() == 'r' )
                {
                    ...
                    osg::ref_ptr< osg::Object > objIn = osgDB::readObjectFile( "physics_state.sgb" );
      ...
      char ** argv )
{
    ...
    SaveRestore* sr = new SaveRestore( root.get(), bulletWorld );
