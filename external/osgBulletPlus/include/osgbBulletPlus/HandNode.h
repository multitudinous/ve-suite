...
#ifndef __OSGBBULLETPLUS_HAND_NODE_H__
#define __OSGBBULLETPLUS_HAND_NODE_H__
...
/*!
   ...
   the hand.
*/
class OSGBBULLETPLUS_EXPORT HandNode : public osg::Transform
{
public:
    ...
    void registerMultiThreaded( osgbBullet::PhysicsThread* pt );
...
// __OSGBBULLETPLUS_HAND_NODE_H__
#endif
