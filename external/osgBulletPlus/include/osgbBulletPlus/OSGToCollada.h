...
#ifndef __OSGBBULLETPLUS_OSG_TO_COLLADA_H__
#define __OSGBBULLETPLUS_OSG_TO_COLLADA_H__ 1
...
class OSGBBULLETPLUS_EXPORT OSGToCollada
{
public:
    ...
    OSGToCollada();
    OSGToCollada( osgbBullet::CreationRecord& cr );
    ~OSGToCollada();
    ...
    osgbBullet::CreationRecord* getOrCreateCreationRecord();
    const osgbBullet::CreationRecord* getOrCreateCreationRecord() const;
...
protected:
    ...
    mutable osg::ref_ptr< osgbBullet::CreationRecord > _cr;
};

// namespace osgbBulletPlus
}

// __OSGBBULLETPLUS_OSG_TO_COLLADA_H__
#endif
