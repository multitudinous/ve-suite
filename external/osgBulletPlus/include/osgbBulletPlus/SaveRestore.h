...
public:
    ...
    //   <baseName>.osgb
    //   <baseName>_skel.osg
    void restore( const std::string& sceneGraphName, osg::Group* attachPoint );
    void restore( const std::string baseName, btDynamicsWorld* bw, osg::Node* root );
    void restore( const std::string baseName, btDynamicsWorld* bw, const std::string& sceneGraphName, osg::Group* attachPoint );
