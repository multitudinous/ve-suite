...
#ifndef __OSGBULLETPLUS_HAND_NODE_H__
#define __OSGBULLETPLUS_HAND_NODE_H__
...
/*!
   ...
   the hand.
*/
class OSGBULLETPLUS_EXPORT HandNode : public osg::Transform
{
public:
    ...
    void registerMultiThreaded( osgBullet::PhysicsThread* pt );
