...
makeScene( btDynamicsWorld* bw )
{
    ...
    geode->addDrawable( osgTools::makeGrid( osg::Vec3( -10, -10, 10 ), osg::Vec3( 20, 0, 0 ), osg::Vec3( 0, 20, 0 ), 5 ) );
    geode->addDrawable( osgTools::makeGrid( osg::Vec3( -10, 0, 0 ), osg::Vec3( 20, 0, 0 ), osg::Vec3( 0, 0, 20 ), 5 ) );
    root->addChild( geode );
      ...
      char ** argv )
{
    ...
    osgBullet::GLDebugDrawer* dbgDraw = new osgBullet::GLDebugDrawer();
