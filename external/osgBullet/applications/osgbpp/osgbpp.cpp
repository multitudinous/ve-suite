          ...
          char* argv[] )
{
    ...
    {
        osg::notify( osg::ALWAYS ) << osgBullet::getVersionString() << std::endl << std::endl;
    }
    ...
    osg::ref_ptr< osgTools::AbsoluteModelTransform > loadedModel( new osgTools::AbsoluteModelTransform );
    {
