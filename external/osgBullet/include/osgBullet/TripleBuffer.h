...
#ifndef __OSGBULLET_TRIPLEBUFFER_H__
#define __OSGBULLET_TRIPLEBUFFER_H__ 1
...
//
// In a typical usage case, each osgBullet MotionState has a matrix
...
// 
class OSGBULLET_EXPORT TripleBuffer
{
public:
