...
struct OSGBULLET_EXPORT MotionStateCallback
{
    MotionStateCallback() {}
    ~MotionStateCallback() {}
...
/*!
    ...
    or an osgTools::AbsoluteModelTransform.
...
public:
    ...
    void registerTripleBuffer( osgBullet::TripleBuffer* tb );
    //
...
private:
    ...
    osg::ref_ptr< osgTools::AbsoluteModelTransform > _amt;
...
typedef std::vector< osgBullet::MotionState* > MotionStateList;

bool OSGBULLET_EXPORT TripleBufferMotionStateUpdate( osgBullet::MotionStateList& msl, osgBullet::TripleBuffer* tb );
