...
#define MyAppName "VE-Builder Tools 1.0.1"
#define MyAppVerName "VE-Builder Tools 1.0.1"
...
DefaultDirName=C:\VE_BuilderTools.1.0.1
DefaultGroupName=VE-Builder_Tools 1.0.1
AllowNoIcons=yes
