...
#define MyAppName "VE-Builder Tools 1.0.6"
#define MyAppVerName "VE-Builder Tools 1.0.6"
...
Source: {#VEHOME}\bin\win32\addNormals2Polyd.exe; DestDir: {app}\bin; Flags: ignoreversion
Source: {#VEHOME}\bin\win32\loaderToVTKd.exe; DestDir: {app}\bin; Flags: ignoreversion
