...
#define MyAppName "VE-Builder Tools .0.9.3"
#define MyAppVerName "VE-Builder Tools .0.9.3"
...
DefaultDirName=C:\VE_BuilderTools.0.9.3
DefaultGroupName=VE-Builder_Tools .0.9.3
AllowNoIcons=yes
OutputBaseFilename=vebuildertools.0.9.3
Compression=lzma
