...
#define MyAppName "VE-Builder Tools 1.0.3"
#define MyAppVerName "VE-Builder Tools 1.0.3"
...
DefaultDirName=C:\VE_BuilderTools.1.0.3
DefaultGroupName=VE-Builder_Tools 1.0.3
AllowNoIcons=true
