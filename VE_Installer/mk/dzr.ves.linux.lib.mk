# This is hacked from VJ_BASE_DIR/share/gadgeteer/gadget.plugin.mk
default: plugin-dso
...
CXX_PROF_FLAGS= 	-pg
C_DLL=			$(CC) -shared $(DPP_EXTRA_LDFLAGS) $(EXTRA_LDFLAGS)
CXX_DLL=		$(CXX) -shared $(DPP_EXTRA_LDFLAGS) $(EXTRA_LDFLAGS)
C_PLUGIN=		$(CC) -shared $(DPP_EXTRA_LDFLAGS) $(EXTRA_LDFLAGS)
CXX_PLUGIN=		$(CXX) -shared $(DPP_EXTRA_LDFLAGS) $(EXTRA_LDFLAGS)
DEP_GEN_FLAG=		-M
DYLIB_NAME_FLAG=	-o $@
JDK_HOME=		@JDK_HOME@
LD=			$(CXX) -shared $(DPP_EXTRA_LDFLAGS) $(EXTRA_LDFLAGS)
...
# -----------------------------------------------------------------------------
EXTRA_CFLAGS+=		 -pipe $(OPTIMIZER) $(CFLAGS_DYNLIB) $(EXTRA_DEFS)
EXTRA_CXXFLAGS+=	 -pipe -pthread $(OPTIMIZER) $(CXXFLAGS_DYNLIB) $(EXTRA_DEFS)
EXTRA_DEFS=		
