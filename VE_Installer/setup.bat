...
set WX_HOME=C:\WxWidgets_2.8.0_Pre-Compile_vc8.0
set WX_HOME=C:\WxWidgets_2.8.0_Pre-Compile_vc8.0
REM set WX_HOME=C:\devEnv\VES.1.0-deps\wxWidgets-2.8.0
REM set WX_ROOT=C:\devEnv\VES.1.0-Deps\wxWidgets-2.8.0
