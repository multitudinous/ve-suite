...
BuildRequires: aaa_base acl attr bash bison bzip2 coreutils cpio cpp devs diffutils e2fsprogs file filesystem findutils gawk gcc gcc-c++ glibc glibc-devel glibc-locale grep gzip info klogd libacl libattr libgcc libstdc++ libstdc++-devel m4 make man mktemp module-init-tools patch permissions popt procinfo procps psmisc pwdutils readline sed sysvinit tar texinfo timezone unzip util-linux zlib zlib-devel autoconf automake binutils doxygen gcc gettext rpm
