...
void UI_NavButton::onMouseUp(wxMouseEvent& WXUNUSED(event))
{
   ...
   //tell cfdApp to stop moving 
   //reset the active button
   ((NavigationPane*)((UI_NavigateScroll*)GetParent())->GetParent())->setActiveButton(NONE);
      
   //relay info to cfdApp 
   ((NavigationPane*)((UI_NavigateScroll*)GetParent())->GetParent())->updateParent(0,-1);
}
///////////////////////////////////////////////
...
{
   int activeId = ((NavigationPane*)((UI_NavigateScroll*)GetParent())->GetParent())->getActiveButton();
   ...
   if(activeId == NONE){     
      if(mouse.LeftIsDown()){
         ...
         ((NavigationPane*)((UI_NavigateScroll*)GetParent())->GetParent())->setActiveButton(GetId());

         //pass the nav info to cfdApp
         ((NavigationPane*)((UI_NavigateScroll*)GetParent())->GetParent())->updateParent(_buttonPushed,GetId());              
      }
   }
}
