...
/*
    ...
    wxBitmap itemtool5Bitmap(contour_xpm);
    wxBitmap itemtool5BitmapDisabled;
    itemToolBar3->AddTool(CONTOUR_BUTTON, _T(""), itemtool5Bitmap, itemtool5BitmapDisabled, wxITEM_RADIO, _T("Scalar Contours"), wxEmptyString);
    wxBitmap itemtool6Bitmap(contour_xpm);
    wxBitmap itemtool6BitmapDisabled;
    itemToolBar3->AddTool(CONTOUR_BUTTON, _T(""), itemtool6Bitmap, itemtool6BitmapDisabled, wxITEM_RADIO, _T("Scalar Contours"), wxEmptyString);
    wxBitmap itemtool7Bitmap(contour_xpm);
    wxBitmap itemtool7BitmapDisabled;
    itemToolBar3->AddTool(CONTOUR_BUTTON, _T(""), itemtool7Bitmap, itemtool7BitmapDisabled, wxITEM_RADIO, _T("Scalar Contours"), wxEmptyString);
    wxBitmap itemtool8Bitmap(contour_xpm);
    wxBitmap itemtool8BitmapDisabled;
    itemToolBar3->AddTool(CONTOUR_BUTTON, _T(""), itemtool8Bitmap, itemtool8BitmapDisabled, wxITEM_RADIO, _T("Scalar Contours"), wxEmptyString);
    wxBitmap itemtool9Bitmap(contour_xpm);
    wxBitmap itemtool9BitmapDisabled;
    itemToolBar3->AddTool(CONTOUR_BUTTON, _T(""), itemtool9Bitmap, itemtool9BitmapDisabled, wxITEM_RADIO, _T("Scalar Contours"), wxEmptyString);
    ...
    if (ShowToolTips())
        itemComboBox11->SetToolTip(("Data Sets"));
    ...
    wxStaticBox* itemStaticBoxSizer14Static = new wxStaticBox(itemDialog1, wxID_ANY, ("Scalars"));
    wxStaticBoxSizer* itemStaticBoxSizer14 = new wxStaticBoxSizer(itemStaticBoxSizer14Static, wxHORIZONTAL);
    itemBoxSizer13->Add(itemStaticBoxSizer14, 1, wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    wxListBox* itemListBox15 = new wxListBox( itemDialog1, ID_LISTBOX, wxDefaultPosition, wxSize(125, -1), 3, itemListBox15Strings, wxLB_SINGLE );
    itemStaticBoxSizer14->Add(itemListBox15, 1, wxGROW|wxALL, 5);

    wxStaticBox* itemStaticBoxSizer16Static = new wxStaticBox(itemDialog1, wxID_ANY, ("Vectors"));
    wxStaticBoxSizer* itemStaticBoxSizer16 = new wxStaticBoxSizer(itemStaticBoxSizer16Static, wxHORIZONTAL);
    itemBoxSizer13->Add(itemStaticBoxSizer16, 1, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxString itemListBox17Strings[] = {
        ("DataSet1"),
        ("DataSet2"),
        ("DataSet3")
    };
    wxListBox* itemListBox17 = new wxListBox( itemDialog1, ID_LISTBOX1, wxDefaultPosition, wxSize(125, -1), 3, itemListBox17Strings, wxLB_SINGLE );
    itemStaticBoxSizer16->Add(itemListBox17, 1, wxGROW|wxALL, 5);

    wxStaticText* itemStaticText18 = new wxStaticText( itemDialog1, wxID_STATIC, ("Max%"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE );
    itemBoxSizer2->Add(itemStaticText18, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP|wxADJUST_MINSIZE, 5);

    wxSlider* itemSlider19 = new wxSlider( itemDialog1, ID_SLIDER, 100, 0, 100, wxDefaultPosition, wxSize(300, -1), wxSL_HORIZONTAL|wxSL_LABELS );
    itemBoxSizer2->Add(itemSlider19, 0, wxGROW|wxLEFT|wxRIGHT|wxTOP, 5);

    wxStaticText* itemStaticText20 = new wxStaticText( itemDialog1, wxID_STATIC, ("Min%"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE );
    itemBoxSizer2->Add(itemStaticText20, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP|wxADJUST_MINSIZE, 5);

    wxSlider* itemSlider21 = new wxSlider( itemDialog1, ID_SLIDER1, 0, 0, 100, wxDefaultPosition, wxSize(300, -1), wxSL_HORIZONTAL|wxSL_LABELS );
    itemBoxSizer2->Add(itemSlider21, 0, wxGROW|wxALL, 5);

    wxButton* itemButton22 = new wxButton( itemDialog1, ID_BUTTON, ("Advanced..."), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer2->Add(itemButton22, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);
*/
