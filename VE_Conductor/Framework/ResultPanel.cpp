 ...
 *
 * -----------------------------------------------------------------
 * File:          $RCSfile: ResultPanel.cpp,v $
 * Date modified: $Date$
 * Version:       $Rev$
 * -----------------------------------------------------------------
 *
  ...
  : wxDialog((wxWindow *) parent, id, "Result Panel", wxDefaultPosition,wxDefaultSize)
{
  ...
  wxStaticBox* cmn_box = new wxStaticBox(this, -1, "Overall Plant");
  wxStaticBoxSizer* cmn_row = new wxStaticBoxSizer(cmn_box, wxVERTICAL);
  wxStaticBox* tex_box = new wxStaticBox(this, -1, "Gasifier Area");
  wxStaticBoxSizer* tex_row = new wxStaticBoxSizer(tex_box, wxVERTICAL);
  wxStaticBox* selx_box = new wxStaticBox(this, -1, "CO2 Capture");
  wxStaticBoxSizer* selx_row = new wxStaticBoxSizer(selx_box, wxVERTICAL);
  wxStaticBox* finance_box = new wxStaticBox(this, -1, "Financial Result");
  ...
  wxStaticText * label0 = new wxStaticText(this, -1, "    Nominal Plant Output", wxDefaultPosition, sz);
  mw_gross = new wxTextCtrl(this, MW_GROSS, wxT("9000"), wxDefaultPosition, wxSize(80, 20));
  wxStaticText * label1 = new wxStaticText(this, -1, " (MW)", wxDefaultPosition, wxSize(80,20), wxTE_READONLY);
  
  cmn_first_row->Add(label0);
  cmn_first_row->Add(mw_gross);
  cmn_first_row->Add(label1);

  wxStaticText * label2 = new wxStaticText(this, -1, "    Net Electrical Output", wxDefaultPosition, sz);
  mw_net = new wxTextCtrl(this, MW_NET, wxT("7000"), wxDefaultPosition, wxSize(80, 20));
  wxStaticText * label3 = new wxStaticText(this, -1, " (MW)", wxDefaultPosition, wxSize(80,20), wxTE_READONLY);
  
  cmn_second_row->Add(label2);
  cmn_second_row->Add(mw_net);
  cmn_second_row->Add(label3);

  wxStaticText * label4 = new wxStaticText(this, -1, "    Net Plant Efficiency", wxDefaultPosition, sz);
  net_eff = new wxTextCtrl(this, NET_EFF, wxT("67"), wxDefaultPosition, wxSize(80, 20));
  wxStaticText * label5 = new wxStaticText(this, -1, " (%)", wxDefaultPosition, wxSize(80,20), wxTE_READONLY);
  
  cmn_third_row->Add(label4);
  cmn_third_row->Add(net_eff);
  cmn_third_row->Add(label5);

  wxStaticText * label6 = new wxStaticText(this, -1, "    Coal In", wxDefaultPosition, sz);
  coal_in = new wxTextCtrl(this, COAL_IN, wxT("9000"), wxDefaultPosition, wxSize(80, 20));
  wxStaticText * label7 = new wxStaticText(this, -1, " (tons/hr)", wxDefaultPosition, wxSize(80,20), wxTE_READONLY);
  
  tex_first_row->Add(label6);
  tex_first_row->Add(coal_in);
  tex_first_row->Add(label7);

  wxStaticText * label8 = new wxStaticText(this, -1, "    Water In", wxDefaultPosition, sz);
  water_in = new wxTextCtrl(this, WATER_IN, wxT("9000"), wxDefaultPosition, wxSize(80, 20));
  wxStaticText * label9 = new wxStaticText(this, -1, " (tons/hr)", wxDefaultPosition, wxSize(80,20), wxTE_READONLY);
  
  tex_second_row->Add(label8);
  tex_second_row->Add(water_in);
  tex_second_row->Add(label9);

  wxStaticText * label10 = new wxStaticText(this, -1, "    Oxidant In", wxDefaultPosition, sz);
  oxid_in = new wxTextCtrl(this, OXID_IN, wxT("9000"), wxDefaultPosition, wxSize(80, 20));
  wxStaticText * label11 = new wxStaticText(this, -1, " (tons/hr)", wxDefaultPosition, wxSize(80,20), wxTE_READONLY);
  
  tex_third_row->Add(label10);
  tex_third_row->Add(oxid_in);
  tex_third_row->Add(label11);

  wxStaticText * label12 = new wxStaticText(this, -1, "    CO2 In", wxDefaultPosition, sz);
  co2_in = new wxTextCtrl(this, CO2_IN, wxT("9000"), wxDefaultPosition, wxSize(80, 20));
  wxStaticText * label13 = new wxStaticText(this, -1, " (tons/hr)", wxDefaultPosition, wxSize(80,20), wxTE_READONLY);
  
  selx_first_row->Add(label12);
  selx_first_row->Add(co2_in);
  selx_first_row->Add(label13);

  wxStaticText * label14 = new wxStaticText(this, -1, "    CO2 Out", wxDefaultPosition, sz);
  co2_out = new wxTextCtrl(this, CO2_OUT, wxT("9000"), wxDefaultPosition, wxSize(80, 20));
  wxStaticText * label15 = new wxStaticText(this, -1, " (tons/hr)", wxDefaultPosition, wxSize(80,20), wxTE_READONLY);
  
  selx_second_row->Add(label14);
  selx_second_row->Add(co2_out);
  selx_second_row->Add(label15);

  wxStaticText * label16 = new wxStaticText(this, -1, "    CO2 Captured", wxDefaultPosition, sz);
  co2_cap = new wxTextCtrl(this, CO2_CAP, wxT("9000"), wxDefaultPosition, wxSize(80, 20));
  wxStaticText * label17 = new wxStaticText(this, -1, " (tons/hr)", wxDefaultPosition, wxSize(80,20), wxTE_READONLY);
  
  selx_third_row->Add(label16);
  selx_third_row->Add(co2_cap);
  selx_third_row->Add(label17);

  wxStaticText * label18 = new wxStaticText(this, -1, "    Capital Cost", wxDefaultPosition, sz);
  capital_cst = new wxTextCtrl(this, CAPITAL_CST, wxT("9000"), wxDefaultPosition, wxSize(80, 20));
  wxStaticText * label19 = new wxStaticText(this, -1, " ($/kWnet)", wxDefaultPosition, wxSize(80,20), wxTE_READONLY);
  
  finance_first_row->Add(label18);
  finance_first_row->Add(capital_cst);
  finance_first_row->Add(label19);

  wxStaticText * label20 = new wxStaticText(this, -1, "    Electricity Cost", wxDefaultPosition, sz);
  elec_cst = new wxTextCtrl(this, ELEC_CST, wxT("9000"), wxDefaultPosition, wxSize(80, 20));
  wxStaticText * label21 = new wxStaticText(this, -1, " ($/MWh)", wxDefaultPosition, wxSize(80,20), wxTE_READONLY);
